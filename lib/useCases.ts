...
export const useCases: Record<string, UseCase> = {
  ...
  "atv-powersports": {
    slug: "atv-powersports",
    h1: "Personal Loans for ATVs and Powersports",
    title: "ATV & Powersports Loan: Finance a Dirt Bike, ATV, or UTV in 2026",
    description: "A personal loan can fund an ATV, UTV, dirt bike, snowmobile, or jet ski - often at lower rates than dealer financing. Compare 2026 rates and the best lenders for powersports.",
    eyebrow: "Use case",
    intro: "ATVs, side-by-sides (UTVs), dirt bikes, snowmobiles, and personal watercraft (jet skis) typically cost $5,000-$25,000 new. Dealer financing for powersports is expensive (12%-25% APR) and may require a large down payment. A personal loan from an online lender can often fund the same purchase at a lower rate with no down payment requirement and without a lien on the vehicle.",
    amountMin: 2000,
    amountMax: 40000,
    termMin: 12,
    termMax: 72,
    ...
    aprMax: 23.99,
    bullets: [
      "Personal loans for powersports carry no vehicle lien - you own the ATV outright",
      "Dealer financing often runs 15%-25% APR; personal loans can beat this significantly",
      "LightStream specifically lists powersports as an approved use case at rates from 7.49%",
      "No down payment requirement with a personal loan (dealer financing often requires 10%-20%)",
      "Fund used private-party purchases that dealer financing cannot cover",
    ],
    faqs: [
      { q: "Personal loan or powersports loan - which is cheaper?", a: "It depends on your credit score. For borrowers with 720+ credit scores, a personal loan from LightStream (7.49%-9.49% APR with AutoPay) typically beats any dealer-offered powersports financing (which runs 12%-20% even for good credit). For borrowers with 640-700 credit, compare specifically: get a pre-qualification from an online lender and the dealer's best rate, then compare APRs directly. Specialized powersports lenders (Sheffield Financial, Synchrony) sometimes offer promotional 0% financing for 12-24 months on select models - if you can pay it off in time and the fine print does not include deferred interest, this can be the cheapest option of all." },
      { q: "Can I use a personal loan to buy a used ATV from a private seller?", a: "Yes - this is one of the key advantages of a personal loan over dealer financing or powersports-specific financing. A personal loan funds directly to your bank account, which you then use to pay the private seller in cash, Venmo, bank transfer, or certified check. Dealer and manufacturer financing only works through their own sales channel. If you find a clean used ATV on Facebook Marketplace or Craigslist for $6,000 below retail, a personal loan is typically your only formal financing option besides a HELOC." },
      { q: "Is ATV financing different from auto loan financing?", a: "Yes - key differences. Auto loans are secured by the vehicle title (the lender holds the title until payoff). Powersports auto loans from credit unions work similarly and may offer competitive rates (8%-15%). Personal loans are unsecured - no lien on the ATV, and the lender cannot repossess the vehicle for non-payment (they must sue for a judgment instead, which is a longer process). Secured powersports loans typically have lower rates for the same credit score because of the collateral. If a credit union offers a secured ATV loan at 9% vs a personal loan at 11%, the secured loan wins on rate - just understand that missed payments can result in repossession." },
    ],
  },
  "musical-instrument": {
    slug: "musical-instrument",
    h1: "Personal Loans for Musical Instruments",
    title: "Musical Instrument Loan: Finance a Guitar, Piano, or Drum Kit in 2026",
    description: "A personal loan can fund professional-grade musical instruments without depleting savings. See 2026 rates, typical instrument costs, and which lenders work best for instrument purchases.",
    eyebrow: "Use case",
    intro: "Professional musical instruments - a high-end acoustic guitar ($2,000-$8,000), upright piano ($5,000-$30,000), drum kit ($2,500-$15,000), or brass instrument ($3,000-$12,000) - represent a significant investment. A personal loan provides a fixed repayment path at a known rate, often cheaper than music store financing or credit card interest.",
    amountMin: 500,
    amountMax: 30000,
    termMin: 12,
    termMax: 60,
    ...
    aprMax: 24.99,
    bullets: [
      "Personal loans fund purchases from any seller - music store, luthier, or private party",
      "Typical rates 8%-20% depending on credit; far cheaper than credit cards at 22%-29%",
      "No collateral required - the instrument does not need to be pledged to the lender",
      "Fund vintage or specialty instruments not eligible for retail store financing",
      "Some music stores offer 0% financing for 6-18 months - compare to personal loan total cost",
    ],
    faqs: [
      { q: "Is a personal loan or music store financing better for buying an instrument?", a: "Music stores frequently offer 0% financing through Synchrony or similar retail credit for 12-18 months. If you can pay off the full instrument price within that window, 0% financing is free money - clearly the best option. If you cannot, these programs almost always use deferred interest: you are retroactively charged interest on the original purchase price at 29.99% APR if any balance remains at the end of the promotional period. A personal loan at 12% APR with no hidden traps is much safer if there is any risk you cannot pay in full by the deadline." },
      { q: "How much should I borrow for a musical instrument?", a: "Rule of thumb: the instrument should last at least as long as the loan term. A $1,500 student-grade guitar financed over 36 months is questionable value - student instruments depreciate quickly and may not survive 3 years of heavy use. A $3,000 professional-grade instrument that holds its value and lasts 20+ years is a reasonable investment to finance. For serious musicians making a career investment (a principal orchestra instrument, a recording studio piano), a personal loan can be genuinely the most practical path. For hobbyists, starting with a lower-cost instrument and saving for the upgrade avoids debt." },
      { q: "Can I use a personal loan to buy a piano that needs to be delivered and tuned?", a: "Yes. A personal loan funds to your bank account, and you can spend the proceeds however the purchase requires - instrument price, delivery fee, professional installation, and initial tuning. Some piano purchases involve moving costs of $400-$1,500 (pianos require specialized movers) plus first-year tuning (two or three tunings to settle after a move, at $100-$200 each). Budgeting the loan amount to cover all piano-related costs in the first year makes more sense than taking a loan for just the purchase price and then scrambling for delivery costs." },
    ],
  },
  "home-office": {
    slug: "home-office",
    h1: "Personal Loans for a Home Office: Rates, Amounts & What to Expect",
    title: "Personal Loan for Home Office Setup (2026): Rates from 7.99% APR",
    description: "Finance your home office setup with a personal loan. Compare rates 7.99%-25.99% APR, loan amounts $2,000-$25,000, and find lenders for remote workers and freelancers in 2026.",
    eyebrow: "Home office financing",
    intro: "Remote work has made the home office a necessity for millions of Americans. A dedicated workspace - desk, ergonomic chair, monitor setup, high-speed internet equipment, lighting, and soundproofing - typically costs $2,000-$15,000 for a professional setup. A personal loan lets you build your home office in one project rather than buying equipment piecemeal over years.",
    amountMin: 2000,
    amountMax: 25000,
    termMin: 12,
    termMax: 60,
