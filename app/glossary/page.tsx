...
export const metadata: Metadata = {
  title: "Personal Loan Glossary: 50 Lending Terms Explained",
  description:
    "Plain-English definitions for personal-loan terminology: APR, amortisation, FICO, TILA, soft inquiry, debt-to-income ratio, and 44 more. Updated by our editorial team.",
  alternates: { canonical: "/glossary" },
  openGraph: {
    title: "Personal Loan Glossary",
    description:
      "50 lending terms explained in plain English by the Get Advance Loan editorial team.",
    url: "/glossary",
  },
};
