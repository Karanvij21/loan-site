...
export const metadata: Metadata = {
  title: "Personal Loan Glossary: 111 Terms Defined (2026)",
  description:
    "Plain-English definitions for 111 personal-loan terms: APR, amortisation, FICO, TILA, soft inquiry, debt-to-income ratio, origination fee, and more. Updated June 2026.",
