...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    slug: "loan-shark",
    name: "Loan Shark",
    aka: ["predatory lender", "unlicensed lender"],
    category: "Lender types",
    ...
    long: "The term 'loan shark' refers to illegal, unlicensed money lenders who charge extremely high interest rates and often resort to intimidation, harassment, or violence to collect. They operate in the shadows of the formal financial system, targeting people who cannot access legal lending.\n\nDistinguishing loan sharks from legal high-cost lenders: Legal payday lenders, title lenders, and installment lenders are licensed by state regulators, disclose APRs, and must comply with consumer protection laws. Their rates are very high (100%-400% APR), but they are legal. Loan sharks charge whatever they want (sometimes 500%-1,000%+ annualized), operate without licenses, face no regulatory oversight, and use illegal methods to collect.\n\nWhere loan sharks operate: In communities with limited banking access and concentrated poverty. In communities where illegal activities are common (gambling debts, drug use). Online scam 'lenders' who charge upfront fees and then disappear are a modern form of financial fraud (though not technically loan sharks in the traditional sense). Targeting recent immigrants unfamiliar with consumer protection laws.\n\nWhy people use loan sharks: Inability to access any formal credit (credit scores below any lender threshold, undocumented immigrants). Urgency (needing cash immediately with no formal options). Fear of rejection. In some cases, social or cultural connections.\n\nIf you are being pressured by a loan shark: Contact your state's attorney general office or consumer protection agency. Contact the CFPB (1-855-411-2372). Contact local law enforcement. Predatory debt collection (threats, harassment, violence) is a crime regardless of whether the underlying debt is legal.",
    related: ["predatory-lending", "payday-loan", "usury"],
  },
  {
    slug: "reaffirmation",
    name: "Reaffirmation",
    aka: ["reaffirmation agreement", "reaffirm a debt"],
    category: "Regulation",
    short: "A legal agreement in bankruptcy proceedings where the debtor agrees to remain personally liable for a specific debt (such as a car loan or personal loan) that would otherwise be discharged. Reaffirmation agreements keep the debt alive after bankruptcy in exchange for typically retaining the collateral or maintaining the lender relationship.",
    long: "When you file for Chapter 7 bankruptcy, most unsecured debts (credit cards, medical bills, personal loans) are discharged - you are no longer legally obligated to pay them. A reaffirmation agreement is a voluntary choice to exclude a specific debt from the discharge, agreeing to continue paying it as if bankruptcy had not occurred.\n\nWhy would anyone reaffirm a debt? Vehicle loans: most people reaffirm a car loan to keep the vehicle. Without reaffirmation, the lender may repossess the car even if you are current on payments, because the discharge removed your personal liability. Secured personal loans: same logic - if you pledged collateral, reaffirmation lets you keep the collateral by maintaining the obligation. Reputational relationships: some debtors reaffirm certain debts to maintain relationships with specific creditors (a local bank or credit union they want to continue using).\n\nRisks of reaffirmation: If you reaffirm a debt and later default, the lender can sue you personally and pursue wage garnishment or bank levies despite the prior bankruptcy. Without reaffirmation, a discharged debt cannot result in a personal judgment against you (though the lender can repossess collateral if you stop paying). The decision to reaffirm is serious and permanent.\n\nReaffirmation for unsecured personal loans: Reaffirming an unsecured personal loan (where there is no collateral at stake) is rarely advisable. You receive nothing in exchange (no collateral to keep) but remain on the hook for a debt that could have been discharged. Consult a bankruptcy attorney before reaffirming any debt.\n\nApproval process: Reaffirmation agreements must be filed with the bankruptcy court. If you are represented by an attorney, the attorney must certify the reaffirmation does not impose undue hardship. The bankruptcy judge may review and decline to approve reaffirmation agreements that appear harmful to the debtor.",
    related: ["chapter-7-bankruptcy", "discharge", "collateral", "judgment-lien"],
  },
  {
    slug: "charge-off",
    name: "Charge-Off",
    aka: ["charged off", "write-off"],
    category: "Credit",
    ...
    long: "A charge-off is a creditor's internal accounting decision, not a legal event affecting your obligation. When a lender charges off a debt, it takes a loss on its financial statements and reclassifies the loan from 'asset' to 'loss.' Banks are required by federal banking regulators to charge off severely delinquent consumer loans at 120-180 days past due.\n\nKey distinction: A charge-off does NOT forgive the debt. Despite the lender writing off the balance, you remain legally obligated to pay the full amount. The charge-off simply means the original lender has stopped expecting payment and has taken its tax and accounting write-off.\n\nWhat happens after a charge-off: Debt sale: in the majority of cases, the original lender sells the charged-off debt to a debt buyer (collection agency) at 1%-10% of face value. The collection agency acquires the right to collect the full amount. Collection activity: the debt buyer (or a third-party collection agency working for the buyer) will contact you seeking payment. New collection accounts may appear on your credit report. Time limits: debts have a statute of limitations - a time limit on how long a creditor can sue to collect the debt. After the statute runs (3-10 years depending on state and debt type), the debt is 'time-barred.' However, the charge-off remains on your credit report for 7 years from the date of first delinquency, regardless of whether the statute of limitations has passed.\n\nCredit report impact: A charge-off is one of the most damaging credit events. It can reduce your credit score by 100-150 points. It remains on your credit report for 7 years from the original delinquency date (not 7 years from the charge-off date). Even after paying a charged-off debt, the item typically remains on your report as 'paid charge-off' - damaging, but less so than unpaid.",
    related: ["delinquency", "collection-agency", "credit-score", "debt-buyer", "statute-of-limitations"],
  },
  {
    slug: "basis-point",
    name: "Basis Point",
    aka: ["bps", "bip"],
    category: "Rates & terms",
    short: "One-hundredth of one percent (0.01%). Basis points are used in finance to express small changes in interest rates with precision. 100 basis points = 1 percentage point. A rate increase from 8.00% to 8.25% is a 25 basis point increase. Used in Federal Reserve rate decisions, loan pricing, and rate comparisons.",
    long: "Basis points (abbreviated 'bps' and colloquially called 'bips') eliminate ambiguity when discussing rate changes. Is a '1% increase' in rates a 1 percentage point increase (from 5% to 6%) or a 1% relative increase (from 5% to 5.05%)? Basis points are unambiguous: 100 bps always means one full percentage point.\n\nConversion: 1 basis point = 0.01%. 10 basis points = 0.10%. 25 basis points = 0.25%. 50 basis points = 0.50%. 100 basis points = 1.00%. 200 basis points = 2.00%.\n\nWhere you encounter basis points: Federal Reserve announcements: 'The Fed raised rates by 25 basis points' means the federal funds rate increased by 0.25 percentage points. Loan pricing sheets: 'Your rate is 150 bps above Prime Rate' means Prime + 1.50%. Mortgage rate locks: 'We'll hold this rate for 45 days for a cost of 0.375 discount points (37.5 basis points of loan amount).' Autopay discounts: 'We offer a 25 basis point (0.25%) rate discount for autopay enrollment.'\n\nWhy it matters for personal loan borrowers: When comparing loan offers, rate differences are often expressed in basis points. A 50 basis point difference in rate on a $20,000 loan over 48 months equals approximately $200 in total interest. A 200 basis point (2%) difference equals approximately $800. The larger the loan and the longer the term, the more meaningful each basis point becomes.",
    related: ["apr", "prime-rate", "sofr", "floor-rate"],
  },
  {
    slug: "correspondent-lender",
    name: "Correspondent Lender",
    aka: ["mortgage banker", "table-funder"],
    category: "Lender types",
    short: "A lender that originates loans using its own funds, then sells those loans to larger financial institutions (banks, mortgage aggregators) after closing. Common in mortgage lending; less common in personal loan markets. The borrower deals with the correspondent lender at origination but may be transferred to the purchasing institution for servicing.",
    long: "A correspondent lender originates loans under its own name and using its own (or a warehouse line of credit's) capital, then sells the completed loans to larger entities (like Fannie Mae, Freddie Mac, or private investors in the mortgage world; or bank portfolios in the personal loan world). This is distinct from a mortgage broker (who arranges loans on behalf of other lenders without funding them) and a direct lender (who funds and typically retains the loan).\n\nHow correspondent lending works in practice: The correspondent lender takes your application, processes, underwrites, and funds the loan. After closing, the lender sells the loan to a larger institution (the 'sponsor' or 'investor'). Servicing may transfer to the purchasing institution or remain with the correspondent. The borrower may receive a notice of transfer of servicing but the loan terms do not change.\n\nCorrespondent lending in personal loans: The personal loan market is dominated by direct lenders (banks, credit unions, fintech platforms) that fund and hold their own loans. Correspondent-style origination is less common than in mortgages. However, some regional and community banks act as correspondents for larger bank partners - offering personal loans under their own brand while the underwriting guidelines and funding come from a larger financial institution. Some fintech lenders operate on a 'partner bank' model where a FDIC-insured bank funds the loans while the fintech originates them - a similar structure.\n\nWhy it matters for borrowers: Correspondent relationships generally do not affect your loan terms, rate, or obligations. However, knowing your servicer may change helps you anticipate the transition notice and ensures you send payments to the correct entity.",
    related: ["servicer", "mortgage-broker", "secondary-market"],
  },
  {
    slug: "seasoning",
    name: "Seasoning (Loan)",
    aka: ["loan seasoning", "seasoning period", "payment history requirement"],
    category: "Application",
    short: "The period of time a loan or credit account must have been open and in good standing before certain financial actions can be taken. Most relevant in mortgage lending, where refinancing often requires 6-12 months of payment history ('seasoning') before the original loan can be replaced.",
    long: "Seasoning refers to the aging of a loan - how long it has been in existence with a payment history. Lenders and secondary market guidelines impose seasoning requirements to ensure loans have demonstrated real-world performance before being refinanced, sold, or modified.\n\nMortgage seasoning examples: Cash-out refinance: most lenders require 6-12 months of on-time payments on the existing mortgage before allowing a cash-out refinance. The original loan must be 'seasoned.' VA loan refinancing: VA streamline refinancing (IRRRL) requires at least 6 months of payment history and 7 months from the first mortgage payment. FHA streamline: requires 210 days from the first mortgage payment and 6 payments made.\n\nPersonal loan seasoning: Personal loans do not have the same formal seasoning requirements as mortgages. However, similar principles apply informally: Refinancing your personal loan typically requires a payment history (some lenders prefer 6+ months of on-time payments on the existing loan). Some lenders require a minimum account age before releasing a co-signer (cosigner release programs often specify 12-48 months of on-time payments). A newly opened personal loan may affect your ability to get another loan immediately - many lenders decline applications when you have a very recent new account.\n\nCredit account seasoning: In credit scoring models, older accounts are generally better for your score. An account opened 5 years ago has more 'seasoning' than one opened last month. Average age of accounts is a factor in credit scoring. Opening many new accounts reduces the average age, temporarily hurting your score.",
    related: ["refinance", "cosigner-release", "average-age-of-accounts", "hard-inquiry"],
  },
  {
    slug: "draw-period",
    name: "Draw Period",
    aka: ["draw phase", "HELOC draw period"],
    category: "Rates & terms",
    short: "The initial phase of a home equity line of credit (HELOC) during which the borrower can access funds up to the credit limit. Draw periods typically last 5-10 years. During this phase, many HELOCs require interest-only payments. After the draw period ends, the repayment period begins (no more draws, principal + interest payments).",
    long: "A HELOC operates in two phases: the draw period and the repayment period. Understanding the draw period is essential to using a HELOC appropriately.\n\nDraw period details: Duration: typically 5-10 years (10 years is common). During this phase, you can borrow, repay, and re-borrow up to your credit limit (revolving). Payments: most HELOCs require interest-only payments during the draw period. This makes payments low during the draw phase. However, no principal is being reduced. End of draw period: when the draw period ends, you can no longer access additional funds. The remaining balance enters the repayment period.\n\nRepayment period details: Duration: typically 10-20 years. Payments: full principal + interest payments, significantly higher than draw-period payments. Payment shock: switching from interest-only to principal-and-interest on a large HELOC balance is called 'payment shock.' Example: $50,000 HELOC balance at 9% APR. Draw period: interest-only = $375/month. Repayment period (15 years): $507/month (35% increase). If you have drawn the full HELOC and relied on low draw-period payments, the transition to repayment can be challenging.\n\nHow HELOCs differ from personal loans: Personal loans are fully amortizing from day one - there is no draw period, no interest-only phase, and no payment shock at the end. The fixed payment structure of a personal loan makes cash flow planning more predictable than a HELOC.\n\nWhen draw periods matter: Renovation projects: you may draw funds over 1-2 years as construction milestones are reached. Income variability: the low draw-period payment reduces monthly obligations when cash is tight. Investment property: some real estate investors use HELOCs as a revolving source of down payment capital during the draw period.",
    related: ["heloc", "home-equity-loan", "repayment-period", "interest-only"],
  },
  {
    slug: "loan-proceeds",
    name: "Loan Proceeds",
    aka: ["loan funds", "disbursed amount", "net proceeds"],
    category: "Application",
    short: "The money you actually receive after a loan is funded. For a personal loan with no origination fee, loan proceeds equal the loan amount. For a loan with a 5% origination fee, the lender deducts the fee from the disbursed amount: a $10,000 loan with a 5% fee disburses $9,500 in proceeds even though you owe $10,000.",
    long: "Loan proceeds is the amount of money that actually arrives in your bank account (or is paid to a third party on your behalf). It is distinct from the loan amount (the total borrowed) when fees are deducted.\n\nNet vs gross proceeds: Gross loan amount: the total you borrow (the amount shown on your loan agreement as the principal). Origination fee: a percentage subtracted from the gross amount before disbursement (typically 1%-8%). Net loan proceeds: what you actually receive. Net proceeds = gross amount - origination fee.\n\nExample: You borrow $15,000 with a 5% origination fee. Origination fee = $750. Net proceeds = $14,250. But your repayment schedule is based on $15,000 (not $14,250). The effective APR reflects this - a $14,250 disbursement on a $15,000 loan obligation means the lender is effectively charging interest on $750 you never received.\n\nWhy this matters when budgeting: If you need exactly $10,000 for a home repair, and your loan has a 4% origination fee, you need to borrow $10,417 to receive $10,000 in proceeds ($10,417 x 0.96 = $10,000). Apply for more than your needed amount to account for the fee, and confirm the net disbursement in the loan disclosure. Some borrowers are surprised when $9,600 arrives instead of the expected $10,000.\n\nLenders with no origination fees: LightStream, Marcus by Goldman Sachs, SoFi, and Discover charge no origination fees, so loan proceeds equal the loan amount. This is a meaningful advantage - you receive the full borrowed amount and can precisely budget the expense.",
    related: ["origination-fee", "disbursement", "apr", "amortization"],
  },
  {
    slug: "residual-income",
    name: "Residual Income",
    aka: ["disposable income", "surplus income"],
    category: "Application",
    short: "The income remaining after all monthly debt obligations, essential expenses, and taxes are paid. Residual income analysis is used by some lenders (particularly VA mortgage underwriters) to ensure a borrower has enough left over each month for living expenses and unexpected costs. Higher residual income indicates greater repayment capacity.",
    long: "Residual income = gross monthly income - total monthly debt payments - estimated living expenses (food, utilities, transportation, childcare) - estimated taxes. The result is what a borrower has left over each month for discretionary spending and savings.\n\nWhere residual income is formally used: VA mortgages: the Department of Veterans Affairs requires lenders to calculate residual income and compare it to minimum thresholds by family size and geographic region. A VA borrower with a family of 4 in the Northeast must have at least $1,003/month in residual income. Standard personal loan underwriting: most personal loan lenders use DTI ratio (total debts / total income) as the primary capacity metric, not formal residual income analysis. However, the concept is similar - lenders informally consider whether your income is sufficient to cover debts and living costs.\n\nWhy residual income is a better measure than DTI alone: DTI tells you what percentage of income goes to debts. It does not tell you whether the remaining income is enough to live on. A borrower earning $3,000/month with 30% DTI ($900 in debt payments) has $2,100 remaining, but if rent is $1,500 and groceries are $400, residual income is only $200/month - barely enough to absorb any unexpected expense. A borrower earning $8,000/month with 40% DTI ($3,200 in debt payments) has $4,800 remaining - much more cushion despite the higher DTI ratio.\n\nImplication for personal loan applicants: While personal lenders primarily use DTI, presenting yourself as having strong residual income (high income relative to both debts and living expenses) may help in manual underwriting scenarios, particularly at credit unions and community banks that evaluate the full picture rather than scoring models alone.",
    related: ["debt-to-income-ratio", "gross-income", "capacity", "net-monthly-income"],
  },
  {
    slug: "blended-rate",
    name: "Blended Rate",
    aka: ["weighted average rate", "combined rate"],
    category: "Rates & terms",
    short: "The single effective interest rate that results from combining two or more loans with different rates into one calculation. Used when refinancing or consolidating to determine whether the new loan is actually cheaper than the existing mix of debts.",
    long: "A blended rate is the weighted average of multiple interest rates, calculated by dividing total annual interest across all debts by the total outstanding principal.\n\nFormula: Blended rate = (Loan A balance x Rate A) + (Loan B balance x Rate B) + ... / (Total balances)\n\nExample: You have a $10,000 credit card at 22% APR and a $5,000 medical bill at 0% (promotional period ending). A lender offers you a $15,000 consolidation loan at 16% APR. Your current blended rate is: ($10,000 x 0.22 + $5,000 x 0.00) / $15,000 = $2,200 / $15,000 = 14.67%. The consolidation loan at 16% is actually more expensive than your blended rate, even though it is less than the credit card rate alone. You would be paying more by consolidating in this scenario.\n\nWhen blended rate matters: Debt consolidation decisions: compare the consolidation loan APR against the blended rate of all debts being consolidated, not just against the highest-rate debt. Refinancing: if you are refinancing one of several loans, a blended rate calculation shows the true before-and-after picture for your total debt load. Mortgage analysis: blended rate comparisons arise when homeowners evaluate first and second mortgage combinations.\n\nLimit of the concept: Blended rate only measures interest cost, not total cost. A lower blended rate that extends the repayment term dramatically can cost more in total interest over the life of the loan. Always calculate both blended rate and total interest paid before deciding to consolidate.",
    related: ["debt-consolidation", "apr", "refinance", "interest-rate"],
  },
  {
    slug: "direct-lender",
    name: "Direct Lender",
    aka: ["direct loan provider"],
    category: "Lender types",
    short: "A lender that funds personal loans directly from its own capital, makes its own credit decisions, and services the loan itself - as opposed to a broker or marketplace that matches borrowers with third-party lenders. Direct lenders include banks, credit unions, and many online lenders.",
    long: "Direct lenders fund loans from their own balance sheet, meaning you borrow money that belongs to the lender (or that the lender has raised through deposits or capital markets). The lender approves or denies your application, sets your rate, and either services the loan itself or sells it to a servicer while retaining origination.\n\nContrast with loan marketplaces and brokers: A loan marketplace (LendingTree, Credible, NerdWallet comparison tools) is not a direct lender. When you submit an application on these platforms, your information is sent to multiple lenders who each independently review and potentially offer terms. The marketplace earns a referral fee when you accept a loan. A mortgage broker works similarly in the home loan context.\n\nAdvantages of direct lenders: One underwriting decision rather than multiple credit inquiries if you apply with a single lender. The entity you talk to is the entity making the credit decision - no middlemen. Rates may be more transparent because the lender controls their own pricing. Often faster disbursement.\n\nAdvantages of marketplaces (indirect): You can compare multiple lender offers with one application. If one lender denies you, others may approve. Useful for rate-shopping with minimal credit inquiry impact (many marketplaces use soft pulls for initial matching).\n\nIs an online lender a direct lender? Not always. Many fintech names are actually marketplace or refer applications to a network of bank partners. Look for the disclosures: if the site says 'funded by [specific bank]' or names a bank partner, it may not be a fully direct lender in the traditional sense. When certainty matters, call and ask: 'Are you a direct lender? Who will fund my loan?'",
    related: ["marketplace-lender", "peer-to-peer-lending", "credit-union", "online-lender"],
  },
  {
    slug: "front-end-dti",
    name: "Front-End DTI",
    aka: ["housing ratio", "front ratio"],
    category: "Rates & terms",
    short: "The percentage of gross monthly income consumed by housing costs alone (rent or mortgage principal, interest, taxes, and insurance). Most personal loan lenders use back-end DTI rather than front-end DTI, but understanding both helps when managing total borrowing capacity near a home purchase.",
    long: "Debt-to-income (DTI) ratio has two versions used in lending:\n\nFront-end DTI = Housing costs only / Gross monthly income. Housing costs include: mortgage principal and interest (or rent), property taxes, homeowner's insurance, HOA dues, private mortgage insurance (PMI). Standard limits for mortgage approval: conventional loans generally allow front-end DTI up to 28%. FHA loans allow up to 31%.\n\nBack-end DTI = All recurring monthly debt payments / Gross monthly income. Adds all other minimum payments: car loans, student loans, credit cards, personal loans, child support, alimony. Standard limits: conventional mortgages allow up to 36-45% (sometimes higher with compensating factors). Personal loan lenders use back-end DTI almost exclusively.\n\nWhy front-end DTI matters for personal loan borrowers: If you plan to buy a home within the next 1-2 years, taking on a personal loan raises your back-end DTI and may push you past mortgage qualification thresholds. Example: You earn $6,000/month. Your target home has a $1,500/month PITI payment (25% front-end DTI, acceptable). But a $500/month personal loan payment raises your back-end DTI from 30% to 38.3%, which may affect mortgage approval. Understanding front-end DTI helps you plan personal borrowing around a future home purchase without jeopardizing mortgage qualification.",
    related: ["debt-to-income-ratio", "gross-income", "capacity", "credit-score"],
  },
  {
    slug: "loan-stacking",
    name: "Loan Stacking",
    aka: ["stacking loans", "multiple concurrent loans"],
    category: "Application",
    short: "Applying for and obtaining multiple personal loans from different lenders in a short time window - often before each lender's credit inquiry shows up on the borrower's report. Loan stacking is considered fraud by most lenders because it circumvents underwriting controls designed to prevent over-borrowing.",
    long: "Loan stacking occurs when a borrower applies for multiple loans simultaneously or in rapid succession, typically targeting lenders before the new tradelines appear on credit reports (credit reports can take 30-60 days to update with new accounts and balances).\n\nWhy borrowers attempt it: They want more total credit than any single lender would approve. By spreading applications across several lenders, each lender sees a debt picture that does not yet include the other loans.\n\nWhy it is problematic - for the borrower: It dramatically increases debt load beyond what any lender's underwriting would have approved if they could see the full picture. Monthly payments compound quickly, often leading to default on multiple accounts simultaneously. Lenders share data through systems like Early Warning Services and ChexSystems, and many cross-reference new-account data before funding. If discovered, the lender may call the loan (acceleration clause) or flag you as a fraud risk. Credit score impact from multiple hard inquiries plus sudden high utilization can be severe.\n\nLender detection methods: Lenders increasingly pull updated bureau data immediately before funding (not just at application). Fraud detection models flag multiple applications in a short window. Lenders in the same network share inquiry and account data in near-real time.\n\nLegal risk: Misrepresenting your financial obligations on a loan application may constitute fraud, particularly if you certify that the application information is accurate at the time of signing. Legitimate alternatives: Ask your current lender to increase your loan amount, or consolidate through a single larger loan rather than stacking.",
    related: ["hard-inquiry", "debt-to-income-ratio", "default", "origination-fee"],
  },
  {
    slug: "per-diem-interest",
    name: "Per Diem Interest",
    aka: ["daily interest", "per-day interest"],
    category: "Rates & terms",
    short: "The amount of interest that accrues on a loan each day. Calculated as (annual interest rate / 365) x outstanding principal. Relevant when paying off a loan early, making a final payoff payment, or when a closing date differs from a billing date.",
    long: "Per diem interest = (APR / 365) x Outstanding principal balance\n\nExample: You have a $10,000 personal loan at 15% APR. Per diem interest = (0.15 / 365) x $10,000 = $4.11 per day.\n\nWhen per diem interest matters:\n\nPayoff amount accuracy: If you request a payoff quote and then wait 5 days to actually pay, you owe the quoted amount plus 5 days of per diem interest ($20.55 in the example). Most lenders provide payoff quotes that are valid for 10-30 days and include a per diem amount so you can calculate the correct total at the time of payment.\n\nFinal payment: Your scheduled final payment may not exactly match the true payoff if payments were made even one day early or late throughout the life of the loan. The lender adjusts the final payment using per diem interest.\n\nLoan closing: In mortgage lending, per diem interest covers the days between your closing date and the end of that month, because the first mortgage payment does not include interest for those days. In personal lending, the same logic applies if a loan funds mid-month.\n\nEarly payoff savings: Paying 10 days early on a $10,000 loan at 15% saves 10 x $4.11 = $41.10. Modest for small loans but meaningful for large balances or long payoff lead-times.\n\nAlways request an updated payoff quote on or close to the day you intend to pay to ensure you clear the balance completely.",
    related: ["payoff-amount", "prepayment-penalty", "amortization", "principal"],
  },
  {
    slug: "payment-shock",
    name: "Payment Shock",
    aka: ["payment increase", "rate reset"],
    category: "Repayment",
    short: "A sudden, significant increase in a required loan payment that a borrower may struggle to absorb. In personal loans, payment shock most commonly occurs when a promotional 0% APR period ends and full interest kicks in, when a variable-rate loan resets upward, or when debt consolidation reduces short-term payments but a borrower takes on new debt.",
    long: "Payment shock describes the jarring experience of a payment rising substantially faster than a borrower's ability to absorb it.\n\nCommon sources in consumer lending:\n\n1. Deferred-interest promotions: A 'no-interest-if-paid-in-full' offer that a borrower did not pay off by the promotional deadline suddenly adds back all accrued interest, often raising the effective payment substantially.\n\n2. Variable-rate loan resets: Personal loans indexed to a benchmark rate (such as the prime rate or SOFR) can see monthly payments rise materially when the index increases. A borrower who qualified at 9% may face 14% if rates rise 5 points over the loan term.\n\n3. Balloon loan maturity: A loan with a large balloon payment due at the end of the term creates payment shock at maturity if the borrower has not planned ahead.\n\n4. Income reduction: Payments that were manageable become shocking if income drops - technically an income event, but borrowers experience it as payment shock.\n\nHow lenders assess payment shock risk: Regulators require lenders to qualify variable-rate borrowers at a stressed (higher) rate to ensure they could afford payments if rates increase. For fixed-rate personal loans, standard qualification already reflects the full payment amount.\n\nHow borrowers manage it: Choose fixed-rate personal loans to eliminate variable payment risk. Understand deferred-interest terms fully and always pay off promotional balances before the deadline. Build an emergency fund that can cover 2-3 months of loan payments.",
    related: ["variable-rate", "deferred-interest", "balloon-payment", "hardship-program"],
  },
  {
    slug: "personal-guarantee",
    name: "Personal Guarantee",
    aka: ["personal liability pledge", "PG"],
    category: "Application",
    short: "A legally binding promise by an individual to repay a debt personally if the primary borrower defaults. In small business lending, owners commonly sign personal guarantees on business loans. In consumer lending, a co-signer or guarantor functions as a personal guarantee. The guarantor's personal assets can be pursued if the primary borrower fails to pay.",
    long: "A personal guarantee eliminates the legal separation between the borrower entity and the individual. When a small business owner signs a personal guarantee on a business loan, the lender can pursue the owner's personal savings, property, and income if the business defaults - not just business assets.\n\nIn consumer personal loans: All unsecured personal loans already involve individual personal liability by default - you sign for the loan personally. The personal guarantee concept becomes most relevant in the small business context. However, when a third party (co-signer or guarantor) signs for a personal loan, they are executing a personal guarantee.\n\nCo-signer vs. guarantor distinction: A co-signer is equally liable from day one - the lender can pursue the co-signer immediately upon default without first trying to collect from the primary borrower. A guarantor (in jurisdictions that distinguish the two) is a secondary obligor - the lender must first exhaust collection efforts against the primary borrower before pursuing the guarantor. In practice, most consumer co-signers function as co-borrowers with immediate joint liability.\n\nRisks for guarantors: The guaranteed debt shows on the guarantor's credit report. Late payments and defaults hurt the guarantor's score. If the primary borrower stops paying, the lender will contact the guarantor for repayment. The guarantor's personal assets (wages via garnishment, bank accounts, property) may be subject to collection.\n\nGetting released from a personal guarantee: Typically requires either full repayment of the loan, a formal co-signer release process (refinancing without the guarantor), or negotiation with the lender.",
    related: ["co-signer", "co-borrower", "guarantor", "default", "cosigner-release"],
  },
  {
    slug: "recourse-loan",
    name: "Recourse Loan",
    aka: ["full-recourse loan"],
    category: "Regulation",
    ...
    long: "Recourse vs. non-recourse is a fundamental distinction in secured lending:\n\nRecourse loan: If you default and the collateral is sold for less than the loan balance (a deficiency), the lender can sue you for the deficiency amount and pursue your other assets - wages, bank accounts, other property - to collect. Example: You take out a $15,000 auto loan (recourse). The car is repossessed and sells for $8,000 at auction. The lender can pursue a $7,000 deficiency judgment against your personal assets.\n\nNon-recourse loan: The lender's recovery is strictly limited to the collateral. If the collateral covers less than the balance, the remaining deficiency is legally uncollectible from the borrower personally. Some states have purchase-money mortgage statutes that make home mortgages non-recourse (California's 580b is the most well-known example), protecting primary residence borrowers from deficiency judgments after foreclosure.\n\nFor personal loans (unsecured): Recourse/non-recourse language is less common in documentation because there is no collateral, but unsecured personal loans are inherently full-recourse - the lender can sue, obtain a judgment, and garnish wages or bank accounts.\n\nWhy it matters for borrowers: In a recourse state, walking away from an underwater car loan or home loan does not end your liability - you may still owe the deficiency. Understanding recourse exposure should factor into decisions about voluntary surrender of collateral or strategic default.\n\nState laws vary significantly: Some states restrict or ban deficiency judgments on auto loans or primary mortgages. Check your state's deficiency judgment statutes before assuming you know your exposure.",
    related: ["collateral", "default", "wage-garnishment", "secured-loan"],
  },
  {
    slug: "simple-interest",
    name: "Simple Interest",
    aka: ["actuarial interest"],
    category: "Rates & terms",
    short: "Interest calculated only on the original principal balance, not on previously accrued interest. Most fixed-rate personal loans use simple interest amortization: each payment covers interest accrued since the last payment and reduces the principal, so interest charged declines over time as the balance falls.",
    long: "Simple interest formula: Interest = Principal x Rate x Time\n\nFor a single period: A $1,000 loan at 10% annual simple interest for 1 year accrues $100 in interest. For 6 months: $50.\n\nContrast with compound interest: Compound interest calculates interest on both the principal and previously accrued (unpaid) interest. Credit cards typically use compound interest on unpaid balances. Savings accounts accrue compound interest in your favor.\n\nHow simple interest works on an amortizing personal loan: While the term 'simple interest' applies, the mechanics are slightly nuanced: Each day (or each payment period), interest accrues on the current outstanding principal at the daily rate (APR / 365). When a payment arrives, it first covers all accrued interest, then reduces principal. Because principal drops with each payment, the interest charged on the next payment is slightly less - this is what creates the amortization schedule where early payments are heavily interest and later payments are heavily principal.\n\nEffect of payment timing on simple interest loans: Paying one day early reduces the interest that accrues to the next payment. Paying one day late increases it. This is why total interest paid on a simple interest loan can vary slightly from the projected schedule based on actual payment dates.\n\nSimple interest vs. precomputed interest: Some older or subprime personal loans use precomputed (add-on) interest, where total interest is calculated up front, added to the principal, and divided into equal payments. With precomputed interest, paying off early does not save as much interest because the lender uses the Rule of 78s or similar method to allocate interest front-loaded. Simple interest loans are generally more favorable for early payoff.",
    related: ["apr", "amortization", "principal", "prepayment-penalty", "per-diem-interest"],
  },
  {
    slug: "usury-law",
    name: "Usury Law",
    aka: ["usury cap", "interest rate ceiling", "rate ceiling"],
    category: "Regulation",
    short: "State statutes that set maximum interest rates lenders may charge on loans. Violation of usury laws can void the interest portion of a loan or, in some states, the entire loan. However, federal law and the 'exportation doctrine' allow banks chartered in certain states to export their home state's (higher) rate ceiling nationwide, which is why many national lenders effectively operate under Delaware or South Dakota rate caps.",
    long: "Usury laws predate the United States - they trace to ancient religious prohibitions on excessive interest. In modern American law, they exist at the state level, and their practical effect depends heavily on where the lender is chartered.\n\nHow state usury caps work: Each state sets maximum APRs for different loan categories (consumer loans, payday loans, mortgages, etc.). For example, some states cap personal loan rates at 18-24% for unlicensed lenders, while others have no effective cap.\n\nThe exportation doctrine: The Supreme Court's Marquette National Bank decision (1978) and subsequent legislation allow nationally chartered banks to charge the interest rate permitted in their home state to borrowers in any state. This is why credit card issuers and many online personal lenders are chartered in Delaware or South Dakota - those states have minimal usury restrictions, allowing the lender to charge rates that might violate the borrower's home state cap. This doctrine effectively nullified most state usury protections for nationally chartered bank products.\n\nWhere state usury caps still have teeth: Non-bank lenders (state-chartered only) must comply with the borrower's state usury law. Rent-a-bank arrangements (where a fintech partners with a bank to export the bank's home-state rates) have faced increased regulatory scrutiny. State caps matter most for payday lenders, title loan companies, and small consumer finance companies.\n\nFederal preemption: The Military Lending Act (MLA) imposes a 36% MAPR cap on consumer loans to active-duty servicemembers, regardless of state law or lender charter - a federal usury cap that applies broadly.\n\nImplication for borrowers: A lender offering 95% APR on a personal loan is not necessarily breaking the law in your state if it uses a bank-partnership model. However, some states have passed newer laws specifically targeting high-rate fintech arrangements.",
    related: ["mapr", "mla", "apr", "subprime", "regulation"],
  },
  {
    slug: "debt-ceiling-personal",
    name: "Debt Ceiling (Personal)",
    aka: ["maximum debt load", "debt capacity"],
    category: "Repayment",
    short: "An informal concept describing the maximum total debt load an individual can responsibly carry based on their income, assets, and financial goals. Unlike the federal government's legislative debt ceiling, a personal debt ceiling is a self-imposed or lender-imposed limit based on DTI analysis and financial planning.",
    long: "A personal debt ceiling is the point at which taking on additional debt would compromise financial stability. It is not a fixed legal limit for consumers, but rather a threshold defined by two measures: Lender-imposed ceiling: the point where your debt-to-income ratio (DTI) exceeds lenders' approval thresholds, typically 36%-50% depending on the lender. At 50% DTI, most lenders decline new credit applications. Self-imposed ceiling: the debt level at which monthly payments leave insufficient cash flow for emergency savings, retirement contributions, and essential living expenses - even if a lender would still approve you.\n\nWhy the personal debt ceiling matters more than the lender's limit: Lenders optimize for repayment probability, not your financial well-being. A lender may approve you at 45% DTI because statistically you are likely to repay, even though at 45% DTI you have very little financial resilience for income disruption, medical emergencies, or unexpected expenses. Setting your personal debt ceiling below the lender's maximum protects against forced default when life does not go as planned.\n\nHow to calculate your personal debt ceiling: Total income - essential living expenses (rent/mortgage, food, utilities, transportation, childcare, insurance) = discretionary income. Your personal debt ceiling is the total debt load whose monthly payments consume no more than 30%-35% of your total gross income, with 5%-10% of gross income remaining for savings after all expenses. This leaves room for an emergency fund and retirement contributions. For most people, this means total debt payments of $800-$1,500/month on a $50,000-$75,000 income.",
    related: ["debt-to-income-ratio", "gross-income", "capacity", "net-monthly-income"],
  },
  {
    slug: "funded-loan",
    name: "Funded Loan",
    aka: ["loan funding", "disbursement", "loan closing"],
    category: "Application",
    short: "A loan is 'funded' when the lender transfers the loan proceeds to the borrower or directly to a creditor being paid off. Funding is the final step in the loan process, occurring after approval, document signing, and any waiting periods. For most personal loans, funding happens via ACH transfer 1-3 business days after final approval.",
    long: "Funded is the status a loan enters when the lender initiates the actual transfer of money. For personal loans, the funding sequence is: Application submitted → underwriting review → conditional approval → document verification and signing → waiting period (if applicable) → funding initiated → ACH transfer sent → funds posted to borrower's account.\n\nFunding timeline by lender type: Online lenders (LightStream, SoFi, Upstart, Avant): 1-3 business days from final approval. Some lenders offer same-business-day funding for applications approved before noon. Banks: 3-7 business days from final approval due to more manual processes and internal transfer systems. Credit unions: 3-7 business days, though some are faster especially for existing members with established accounts.\n\nWhat happens at funding: The lender initiates an ACH transfer (Automated Clearing House) for the net loan amount (gross amount minus origination fee, if any) to the bank account number provided during the application. Your bank must then receive and process the ACH, which takes an additional 1-2 business days depending on your bank's ACH processing schedule. This is why applying early in the week ensures funds arrive before the weekend - an ACH sent Thursday afternoon may not post until Monday.\n\nDirect-to-creditor funding: For debt consolidation loans, some lenders offer to pay creditors directly rather than depositing funds to your account. This is sometimes slightly faster per creditor (the lender has established ACH relationships with major card issuers) and reduces the risk that borrowers spend the funds on other things instead of paying off the targeted debts.\n\nLoan funding date vs. first payment date: The first payment due date is typically 30-45 days after the loan funding date. Interest begins accruing from the funding date (the date money is transferred), not the application date.",
    related: ["disbursement", "origination-fee", "ach-transfer", "per-diem-interest"],
  },
  {
    slug: "income-to-debt-ratio",
    name: "Income-to-Debt Ratio",
    aka: ["IDR", "income coverage ratio"],
    category: "Application",
    short: "The inverse of DTI - calculated as gross monthly income divided by total monthly debt obligations. A higher income-to-debt ratio indicates more financial capacity. An income-to-debt ratio of 3.0 means income is 3x the monthly debt load, equivalent to a 33% DTI. Some lenders use this framing rather than DTI when presenting underwriting criteria.",
    long: "Income-to-debt ratio (IDR) = Gross monthly income / Total monthly minimum debt payments\n\nExample: $6,000 monthly income / $1,800 monthly debt payments = IDR of 3.33. This is equivalent to a DTI of 30% ($1,800 / $6,000 = 30%).\n\nWhy some lenders use IDR instead of DTI: From a borrower communication standpoint, 'your income is 3.3x your debt payments' sounds more positive and actionable than 'your DTI is 30%.' Some credit counseling and personal finance contexts use IDR to help borrowers frame their debt situation in terms of capacity rather than percentage burden.\n\nWhat IDR benchmarks mean: IDR of 5.0+ (DTI 20% or below): excellent financial capacity, strong qualifier at all lenders. IDR of 3.0-5.0 (DTI 20%-33%): good capacity, qualifies at most lenders at competitive rates. IDR of 2.0-3.0 (DTI 33%-50%): approval possible but rates may be higher; some lenders begin declining in this range. IDR below 2.0 (DTI above 50%): most lenders decline; borrower may be carrying too much debt relative to income.\n\nIDR vs. DTI: same information, different framing. Both ratios describe the same relationship between income and debt; they simply express it differently. Understanding both helps when reading lender materials that may use either framing. A personal loan lender advertising 'minimum income-to-debt ratio of 2.5' is requiring a maximum DTI of 40%.",
    related: ["debt-to-income-ratio", "gross-income", "capacity", "net-income"],
  },
  {
    slug: "loan-flipping",
    name: "Loan Flipping",
    aka: ["loan churning", "serial refinancing"],
    category: "Regulation",
    short: "A predatory practice where a lender repeatedly encourages a borrower to refinance their existing loan into a new loan - each time collecting new origination fees and extending the loan term - without meaningful financial benefit to the borrower. The CFPB and state regulators identify loan flipping as an unfair, deceptive, or abusive act or practice (UDAAP).",
    long: "Loan flipping works by exploiting a borrower's financial vulnerability and short-term thinking. Scenario: A borrower has a $10,000 personal loan with 18 months remaining at 22% APR. The lender calls and offers to 'consolidate' into a new $12,000 loan at 21% APR - slightly lower rate, but a new 4-year term, and $2,000 of the new loan covers a 5% origination fee and remaining balance is cash in hand. The borrower gets a lower monthly payment (because the term is extended) and a small cash bonus. But the total interest paid over the new 4-year term vastly exceeds what remained on the original loan. This cycle can repeat every 12-18 months.\n\nHow flipping harms borrowers: Repeatedly paying origination fees (1%-8% each time) substantially increases the cost of the underlying debt. Extending the loan term keeps the borrower in debt longer and accumulates more total interest. The cash-out component encourages spending beyond debt management needs. Borrowers in a flip cycle may never make meaningful progress toward debt elimination.\n\nRegulatory treatment: The CFPB's guidance on UDAAP considers serial refinancing without genuine benefit to the borrower as potentially unfair or deceptive. State regulators in California, New York, and others have specific rules requiring lenders to demonstrate that refinancing provides a 'net tangible benefit' to the borrower.\n\nHow to protect yourself: Calculate total cost of refinancing (remaining interest on old loan + new loan's total interest and fees) vs. continuing with the original loan. If total cost of refinancing is higher and you are not receiving a materially lower rate, decline. Refinancing to a genuinely lower rate that saves more in interest than it costs in fees is legitimate; flipping for the lender's benefit at the borrower's expense is not.",
    related: ["refinance", "origination-fee", "prepayment-penalty", "apr"],
  },
  {
    slug: "minimum-viable-credit",
    name: "Minimum Viable Credit",
    aka: ["minimum qualifying credit", "credit floor"],
    category: "Credit",
    short: "An informal term describing the lowest credit score and profile at which a specific lender will approve a personal loan application. Every lender has a minimum viable credit threshold (some published, most not). Knowing the minimum helps borrowers target lenders likely to approve rather than accumulating hard inquiries at lenders that will decline.",
    long: "Minimum viable credit is not a standardized term - it is a conceptual framework for understanding that every lender has a credit floor below which they will not lend, regardless of other factors.\n\nKnown lender minimums (approximate, subject to change): LightStream: 660 FICO (estimated). Requires excellent credit with established history. SoFi: 650 FICO (estimated). Focuses on high-income borrowers with strong profiles. Upstart: 580 FICO (published minimum). Uses AI model with education and employment weighting. Avant: 580 FICO (estimated). Designed for near-prime borrowers. OneMain Financial: no published minimum FICO. Relies heavily on income and collateral. Secured/credit union loans: often no minimum, determined case-by-case.\n\nWhy minimum viable credit is directional, not absolute: A borrower at exactly the lender's minimum FICO may be declined if other factors are unfavorable (high DTI, insufficient income, short credit history, recent delinquency). A lender's minimum is a necessary but not sufficient condition for approval. The minimum gets you in the door; the full profile determines whether you get the loan.\n\nStrategy for borrowers near a lender's minimum: First target lenders whose minimums you comfortably exceed. Save lenders at the edge of your score for after you have tried the better matches. Use soft-pull pre-qualification widely (most major online lenders offer this) to get indicative approvals before triggering hard inquiries. When your score is exactly at the minimum, applying with a co-borrower who is above the minimum may help.",
    related: ["credit-score", "fico-score", "hard-inquiry", "soft-inquiry", "pre-qualification"],
  },
  {
    slug: "net-tangible-benefit",
    name: "Net Tangible Benefit",
    aka: ["NTB", "tangible benefit test"],
    category: "Regulation",
    short: "A regulatory standard requiring that a loan refinancing or new loan provide a meaningful, quantifiable financial benefit to the borrower. Net tangible benefit tests are common in mortgage anti-predatory lending laws and are increasingly applied to consumer loan refinancing. A refinance that extends the term without reducing the rate, or where fees exceed interest savings, may fail the NTB test.",
    long: "The net tangible benefit (NTB) standard originated in mortgage lending regulation as a check against predatory refinancing (loan flipping). Several states applied it to home loans after the predatory lending crisis of the early 2000s.\n\nWhat constitutes net tangible benefit: Rate reduction: the new loan's APR is materially lower than the existing loan (typically by at least 0.5%-1%). Payment reduction: monthly payment decreases meaningfully, and the savings are not offset by a term extension that dramatically increases total interest paid. Cash-out for verified purpose: cash-out refinancing for home improvement or debt consolidation, where the new total cost is calculably beneficial. Reduced term: shortening the loan term to save total interest, even if monthly payment rises.\n\nWhat does NOT constitute net tangible benefit: Reducing monthly payment solely by extending the loan term (rate unchanged). Refinancing primarily to collect a new origination fee. Providing cash-out that the borrower does not need when it increases total debt burden. Changing from a fixed rate to a variable rate without meaningful rate reduction.\n\nApplication to personal loans: Federal law does not universally require NTB analysis for personal loan refinancing (it is most established for mortgages). However, the CFPB's UDAAP authority allows it to pursue lenders whose refinancing practices systematically harm borrowers. Consumer advocates argue that any personal loan refinancing should pass an informal NTB test: total cost of the new loan (principal + interest + fees) should be less than the total remaining cost of the existing loan (remaining interest payments).",
    related: ["refinance", "loan-flipping", "prepayment-penalty", "origination-fee", "apr"],
  },
  {
    slug: "open-end-vs-closed-end",
    name: "Open-End vs. Closed-End Credit",
    aka: ["revolving vs. installment credit"],
    category: "Rates & terms",
    short: "Open-end credit (credit cards, HELOCs, personal lines of credit) allows repeated borrowing up to a credit limit without a fixed payoff date. Closed-end credit (personal loans, auto loans, mortgages) has a fixed loan amount, fixed repayment schedule, and a defined end date. Personal loans are always closed-end; credit cards are always open-end.",
    long: "The open-end / closed-end distinction is fundamental in consumer lending and determines how credit is regulated, reported, and managed.\n\nOpen-end (revolving) credit characteristics: Borrower can draw, repay, and borrow again repeatedly. No fixed loan amount - available credit replenishes as balances are paid. Minimum payment required monthly (typically 1%-2% of balance or a fixed minimum). No defined payoff date. Interest is calculated on current balance, not a fixed original amount. Credit utilization ratio (balance/limit) directly affects credit score.\n\nClosed-end (installment) credit characteristics: Fixed loan amount determined at origination. Fixed monthly payment schedule (amortization schedule). Defined end date (final payment date). Interest calculated on declining balance as principal is paid down. Credit utilization is not applicable in the same way - FICO evaluates installment utilization separately and less heavily than revolving utilization. Lenders: personal loans, auto loans, student loans, mortgages are all closed-end.\n\nWhy the distinction matters for borrowers: Credit score impact: paying off a credit card (open-end) reduces utilization immediately and shows up within 30 days as a score boost. Paying off a personal loan (closed-end) does not reduce revolving utilization. Flexibility: an open-end HELOC allows drawing funds as needed; a personal loan gives you a fixed amount. Psychological: a closed-end personal loan forces a payoff discipline that revolving credit does not. Rate: personal loan rates are fixed and defined at origination; credit card rates can change.\n\nRegulation: TILA regulates both, but with different disclosure requirements. Open-end credit requires periodic statement disclosures; closed-end credit requires disclosure before consummation.",
    related: ["personal-line-of-credit", "heloc", "revolving-credit", "installment-loan", "tila"],
  },
  {
    slug: "payment-grace-period",
    name: "Payment Grace Period",
    aka: ["payment grace", "late payment window"],
    category: "Repayment",
    short: "The number of days after a due date during which a payment can be received without triggering a late fee or negative credit reporting. Most personal loans have a grace period of 10-15 days. Payment received after the grace period ends incurs a late fee and may be reported to credit bureaus.",
    long: "Payment grace periods provide a buffer between the due date and the point at which penalties are triggered. They exist because payment systems are not instantaneous (ACH transfers take 1-2 business days) and because some borrowers have minor timing issues (paycheck arriving 2 days after the loan due date).\n\nTypical grace period lengths: Most major personal loan lenders: 10-15 days after the due date. Some credit unions: 5-10 days. Payday and high-rate lenders: often no grace period, or 1-5 days only. The grace period is specified in your loan agreement. Look for language like 'a late charge will be assessed if payment is not received within X days of the due date.'\n\nWhat the grace period does and does not protect: Protects from: late fee (typically $25-$40 or 5% of payment, whichever is less, up to a CFPB-recommended cap). Credit reporting: most lenders do not report a payment as late to credit bureaus until it is 30 days past due (some wait 60 days). The grace period window is separate from the 30-day reporting threshold. Does NOT protect from: interest accrual. Interest continues accumulating daily from the due date even during the grace period. The loan is still technically past due during the grace period, even if the lender's systems have not yet triggered penalties.\n\nCredit reporting vs. grace period: A payment that arrives on day 12 (within a 15-day grace period) avoids a late fee but is technically late. If the lender has a policy of not reporting until 30 days past due, the credit report shows no late payment. However, patterns of consistent grace-period payments may cause lenders to re-evaluate creditworthiness internally, even without credit bureau impact.\n\nAutomatic payment (autopay) and grace periods: Setting up automatic payment from your bank account is the safest way to ensure payments post by or before the due date. This eliminates reliance on the grace period entirely and often earns an autopay rate discount (0.25%-0.50% APR) from many lenders.",
    related: ["grace-period", "late-fee", "payment-history", "delinquency"],
  },
  {
    slug: "secured-vs-unsecured",
    name: "Secured vs. Unsecured Loan",
    aka: ["collateralized vs. uncollateralized"],
    category: "Lender types",
    short: "A secured loan requires collateral (an asset the lender can seize if you default). An unsecured loan has no collateral and relies solely on your creditworthiness. Most personal loans are unsecured. Secured personal loans (backed by a savings account, car, or other asset) offer lower rates and higher approval odds for borrowers with poor credit.",
    long: "The secured/unsecured distinction is among the most fundamental in lending.\n\nUnsecured personal loans (most common): No collateral required. Lender's only recourse if you default is to sue for a judgment and attempt to collect via wage garnishment, bank levy, or property liens. This risk is priced into higher interest rates. Qualification relies entirely on credit score, income, and DTI. Amounts typically $1,000-$100,000.\n\nSecured personal loans: Borrower pledges an asset as collateral. Common collateral types: savings account or CD (credit union share-secured loans), vehicle title (car, truck, motorcycle), home equity (technically a HELOC or home equity loan, but sometimes called a secured personal loan). If you default, the lender can seize and sell the collateral without needing a court judgment in most cases. Rates are lower because the lender's risk is reduced. Approval is more accessible for borrowers with poor credit.\n\nCredit union share-secured loans: A borrower deposits $5,000 into a savings account, which is then 'secured' or frozen. The borrower takes out a $5,000 loan against that deposit. Interest rate: typically savings account rate + 2%-3% (often 4%-7% APR total). These loans are excellent for credit building because the loan is essentially risk-free for the lender. After payoff, the savings are released.\n\nRisk difference for the borrower: Unsecured loan: if you default, your credit score suffers and a lender may sue you, but you retain your assets during the process. Secured loan: if you default, you lose the collateral immediately (or after brief cure period). Pledging your only car or your emergency savings as collateral on a secured loan creates significant personal risk if your financial situation deteriorates.",
    related: ["collateral", "secured-loan", "unsecured-loan", "unsecured-debt", "collateral", "lien"],
  },
  {
    slug: "yield-spread",
    name: "Yield Spread",
    aka: ["credit spread", "risk premium"],
    category: "Rates & terms",
    short: "In lending, the yield spread is the difference between a benchmark interest rate (such as the U.S. Treasury rate or the prime rate) and the rate charged to a borrower. Higher-risk borrowers pay higher yield spreads. The spread compensates the lender for credit risk, operational costs, and profit. Personal loan yield spreads over prime can range from 2%-20%+ depending on borrower creditworthiness.",
    long: "Yield spread is how lenders price credit risk into interest rates.\n\nFormula: Borrower rate = Benchmark rate + Yield spread. If the prime rate is 8.5% and a borrower's personal loan rate is 14%, the yield spread is 5.5%. This 5.5% compensates for the additional risk that this borrower will not repay, plus the lender's operating costs and profit margin.\n\nWhat drives the yield spread on personal loans: Credit score: the largest determinant. A 780 borrower may receive a 3% spread over prime; a 580 borrower may receive a 15% spread. Loan term: longer terms carry higher spreads because uncertainty increases over time. Loan purpose: some lenders price by purpose. Home improvement loans historically have lower default rates than debt consolidation loans, so the spread may be lower. Employment stability: verified, long-term employment reduces the spread vs. self-employed or gig income.\n\nBenchmark rates used in personal lending: Unlike mortgages (which often reference 10-year Treasury yields) or credit cards (which reference prime), most personal loan lenders do not explicitly reference a public benchmark. They set rates based on cost of capital, competitive pricing, and proprietary risk models. However, when the Federal Reserve raises the federal funds rate, personal loan rates often follow because lenders' cost of capital rises.\n\nFor borrowers: understanding yield spread explains why your rate is what it is. A lower credit score widens the spread. Improving your credit profile (score, income, DTI) before applying narrows the spread, lowering your cost of borrowing.",
    related: ["apr", "prime-rate", "federal-funds-rate", "risk-based-pricing", "fixed-rate"],
  },
  {
    slug: "cross-collateralization",
    name: "Cross-Collateralization",
    aka: ["cross-collateral clause", "dragnet clause"],
    category: "Lender types",
    short: "A provision in a loan agreement that ties multiple loans together, using one asset as collateral for more than one debt with the same lender. Common in credit union loan agreements. If you have a car loan and a personal loan at the same credit union with a cross-collateralization clause, the credit union may keep your car title until BOTH loans are paid off.",
    long: "Cross-collateralization means a single piece of collateral secures multiple obligations with the same lender. This is most commonly encountered at credit unions but can appear in bank agreements as well.\n\nHow it works: Scenario: You take out a $25,000 auto loan at ABC Credit Union, secured by your car. A year later, you take out a $5,000 personal loan at the same credit union. The personal loan agreement contains a cross-collateralization clause (also called a 'dragnet clause'). This clause means your car now serves as collateral for both loans. Even when you pay off the auto loan in full, ABC Credit Union may retain a security interest in your car until the personal loan is also paid in full.\n\nWhy lenders use cross-collateralization: It provides additional security for unsecured or lightly secured loans without requiring additional collateral documentation. It reduces lender risk on personal loans that would otherwise be entirely unsecured.\n\nWhy borrowers should watch for it: You may be unable to sell your car (or transfer a clear title) even after paying off the auto loan if a cross-collateral clause applies. This surprises many borrowers who expect a lien release after paying off the car. Cross-collateralization can also mean the credit union may offset deposits or seize the collateral if you default on any cross-collateralized loan.\n\nHow to avoid it: Read loan agreements carefully, specifically looking for language about 'other obligations,' 'all sums owed,' or cross-collateralization. Ask the lender directly: 'Does this loan agreement cross-collateralize with my other loans here?' Some credit unions will remove this clause on request. Or use different lenders for secured and unsecured borrowing to avoid the issue entirely.",
    related: ["collateral", "lien", "security-interest", "credit-union"],
  },
  {
    slug: "adverse-action-notice",
    name: "Adverse Action Notice",
    aka: ["denial letter", "ECOA notice"],
    category: "Regulation",
    short: "A written notice required by ECOA and FCRA that lenders must send within 30 days of denying a credit application. It must state the specific reasons for denial (or tell you how to find out) and identify the credit bureau whose report was used.",
    long: "An adverse action notice is a federally mandated disclosure triggered whenever a lender takes a negative action on a credit application - including outright denial, approval for less than requested, or counter-offer at less favorable terms than applied for.\n\nLegal basis: Two federal laws require adverse action notices. ECOA (Equal Credit Opportunity Act) requires notice within 30 days of a completed credit application. FCRA (Fair Credit Reporting Act) adds additional requirements when the decision was based on a consumer report, including identifying the reporting agency used and informing the applicant of the right to a free copy of the report.\n\nWhat the notice must include: Statement that adverse action was taken. Specific reasons for the action (or the right to request reasons within 60 days). Name and contact information of any credit reporting agency used. Statement that the credit reporting agency did not make the decision and cannot provide reasons. Notice of right to a free credit report within 60 days from the bureau identified.\n\nWhy it matters for borrowers: The specific denial reasons are valuable diagnostic information. If you are denied for 'too many late payments,' you know to focus on payment history improvement. If denied for 'insufficient income,' you know the lender has a higher income requirement. The free credit report triggered by an adverse action notice lets you verify that the bureau's information is accurate.\n\nCommon adverse action reason codes: 'Too many late payments' - 30+ day delinquencies in your history. 'High proportion of revolving balances to limits' - high credit utilization. 'Too many recent applications for credit' - multiple hard pulls. 'Insufficient income' - lender's DTI threshold not met. 'Length of credit history too short' - thin credit file.",
    related: ["equal-credit-opportunity-act", "fair-credit-reporting-act", "hard-inquiry", "denial-reasons"],
  },
  {
    slug: "balloon-payment",
    name: "Balloon Payment",
    aka: ["bullet payment", "balloon"],
    category: "Rates & terms",
    short: "A large lump-sum payment due at the end of a loan term, after a series of smaller regular payments. Personal loans rarely have balloon payments - they are more common in mortgages and commercial loans. If you see a balloon payment in a personal loan, it is a red flag.",
    long: "A balloon payment is a final payment that is significantly larger than the preceding installment payments. Unlike a fully amortizing loan (where equal monthly payments pay off both principal and interest completely by the final payment), a balloon loan has a residual principal balance due at maturity.\n\nExample: A $20,000 loan with monthly payments calculated as if it were a 30-year mortgage, but with a 5-year balloon - after 5 years of small payments, a large lump sum (perhaps $18,000) comes due all at once.\n\nWhy balloon payments are used: They allow lower regular payments during the loan term, which can make a loan appear more affordable in the short term. Commercial real estate and business loans commonly use balloon structures because the borrower plans to refinance or sell the asset before the balloon comes due.\n\nWhy they are a red flag for personal loans: Consumer financial protection regulators have identified balloon-payment personal loans as a predatory lending risk. If a borrower cannot make the balloon payment (very common), they must refinance - often at a higher rate, which benefits the lender. Some payday loan structures and predatory installment loans use balloon payments to create debt traps. Qualified Mortgage rules for home loans prohibit balloon payments for most residential mortgages. Personal loan borrowers should always review the amortization schedule to confirm the final payment amount equals a regular payment, not a large balloon.",
    related: ["amortization", "maturity-date", "refinancing", "predatory-lending"],
  },
  {
    slug: "creditor-vs-lender",
    name: "Creditor vs. Lender",
    aka: [],
    category: "Lender types",
    short: "Both terms refer to an entity that extends credit, but lender usually implies direct loan origination while creditor is broader - covering anyone to whom money is owed, including credit card companies, hospitals, or utility providers. In personal loan context, the terms are often used interchangeably.",
    long: "In everyday use, creditor and lender are often synonymous, but they have distinct technical meanings in consumer finance and law.\n\nLender: Specifically an entity that originates and funds loans. A lender enters into a formal loan agreement, sets an interest rate, and schedules repayment. Banks, credit unions, online personal loan companies, and mortgage companies are all lenders. The term implies the extension of borrowed money under a formal credit agreement.\n\nCreditor: A broader legal term for any entity to whom money is owed. Every lender is a creditor, but not every creditor is a lender. A hospital that provides medical services and bills you afterward is a creditor but not a lender. A credit card issuer is a creditor (and technically a revolving credit lender). A utility company that provides service before payment is a creditor. Under ECOA and FCRA, 'creditor' is the statutory term used for entities subject to federal consumer credit law.\n\nWhy the distinction matters: In bankruptcy law, creditors are classified by priority (secured vs. unsecured, preferred vs. general). In debt collection, a creditor is the original holder of the debt, while a debt collector is a third party that has purchased or been assigned the debt. When reviewing a personal loan agreement, 'Lender' in the document header is the entity originating your specific loan. After the loan is sold to a third party, that party becomes the new creditor/holder.\n\nPractical note for borrowers: If your loan is sold to a loan servicer, your monthly payments go to the servicer, not the original lender. The servicer collects on behalf of whoever holds the note (the creditor). This is standard and does not change your loan terms.",
    related: ["loan-servicer", "debt-buyer", "origination", "secured-vs-unsecured"],
  },
  {
    slug: "annual-percentage-yield",
    name: "Annual Percentage Yield (APY)",
    aka: ["APY", "effective annual rate"],
    category: "Rates & terms",
    short: "APY measures the true annual return on a savings or investment account, accounting for compounding. It is NOT the same as APR, which measures loan costs. Borrowers encounter APY when looking at savings accounts where their emergency fund earns interest; you want a higher APY on savings and a lower APR on loans.",
    long: "APY (Annual Percentage Yield) is the annualized rate of return on a deposit account, factoring in the effect of compounding interest. It is distinct from APR (Annual Percentage Rate), which measures the annualized cost of borrowing.\n\nAPY formula: APY = (1 + periodic rate)^n - 1, where n is the number of compounding periods per year. Example: A savings account with a 5.00% nominal annual rate compounded monthly has an APY of (1 + 0.05/12)^12 - 1 = 5.116%. The 0.116% difference represents the benefit of monthly compounding.\n\nAPR vs. APY - the critical consumer distinction: APR (loan cost): Defined by TILA. Represents the annualized cost of credit including interest and certain fees. Does NOT account for compounding of interest (this understates the true cost of compound-interest loans). APY (savings return): Defined by the Truth in Savings Act. Represents the annualized return on deposits including compounding. Gives a more accurate picture of savings growth.\n\nWhy this matters to personal loan borrowers: If you are building an emergency fund while repaying a personal loan, the APY on your savings account and the APR on your personal loan determine whether you should prioritize debt repayment over savings accumulation. General rule: if your loan APR exceeds your savings APY (nearly always true), every dollar of emergency fund above your minimum buffer is mathematically better deployed reducing loan principal.\n\nWhere to find competitive APYs: High-yield savings accounts at online banks (Ally, Marcus, SoFi) typically offer APYs of 4%-5% in 2026, far above national average savings rates of 0.4%-0.6% at traditional banks.",
    related: ["annual-percentage-rate", "compound-interest", "simple-interest", "truth-in-lending-act"],
  },
  {
    slug: "debt-consolidation-loan",
    name: "Debt Consolidation Loan",
    aka: ["consolidation loan", "balance transfer loan"],
    category: "Repayment",
    short: "A personal loan used to pay off multiple existing debts - typically high-interest credit cards - and replace them with a single fixed-rate loan at a lower APR. The goal is to reduce total interest paid and simplify monthly payments into one predictable amount.",
    long: "A debt consolidation loan is a type of personal loan whose purpose is to pay off multiple existing debts, leaving the borrower with a single loan to repay. The financial benefit requires that the new loan's APR be meaningfully lower than the weighted average APR of the debts being consolidated.\n\nMath example: $15,000 in credit card debt at 24% APR (minimum payments only = decades of repayment, thousands in interest). Consolidation loan at 14% APR, 4-year term: $388/month, total interest = $3,624. Same $15,000 at 24% APR paid over 4 years: ~$438/month, total interest = $6,024. Savings: $2,400 in interest plus psychological simplicity.\n\nWhen debt consolidation works: Borrower qualifies for a rate significantly lower than existing debt rates. Borrower will not run up the credit cards again after consolidating (this is the most common failure mode - cards are paid off but then re-accumulated). Monthly consolidated payment is manageable within the budget.\n\nWhen consolidation fails or backfires: Rate improvement is marginal (less than 3-4 percentage points). Borrower uses the freed-up credit card capacity to accumulate new debt. Loan term is extended so far that total interest paid exceeds the original debt. Origination fees offset the interest savings.\n\nCredit score impact: Hard inquiry at application: -5 to -10 points temporarily. New account lowers average age of accounts: small negative short-term. Reduced credit utilization (cards paid off): positive effect if cards are kept open but not charged up. Net effect: credit score often improves after 6-12 months of on-time payments on the consolidation loan.\n\nAlternatives: Balance transfer credit card (0% intro APR for 15-21 months, 3%-5% transfer fee) for smaller amounts repayable within the promo window. Home equity (HELOC or cash-out refi) for larger debt amounts with home equity available - lower rates but secured by the home.",
    related: ["debt-to-income-ratio", "annual-percentage-rate", "balance-transfer", "credit-utilization"],
  },
  {
    slug: "grace-period-loans",
    name: "Grace Period (Loans)",
    aka: ["payment grace period", "late payment window"],
    category: "Repayment",
    short: "The number of days after a due date during which a late payment will not be reported to credit bureaus or trigger a late fee. Typical personal loan grace periods are 10-15 days. After the grace period ends, late fees apply. After 30 days, the delinquency is reportable to credit bureaus.",
    long: "A grace period in loan context is the window of time after a scheduled payment due date during which the lender will not assess a late fee and will not report the payment as late to credit bureaus.\n\nTypical personal loan grace periods: Most personal loan servicers provide a grace period of 10-15 calendar days. Some extend to 30 days. Check your specific loan agreement for the exact grace period - it is typically disclosed in the 'Late Charges' or 'Payment' section.\n\nWhat happens at each threshold: Day 1 after due date: payment is technically late, but within the grace period - no fee, no credit bureau reporting. Day 10-15 (after grace period): late fee assessed. Common amounts: $25-$40 flat fee, or 5% of the payment amount, whichever is greater. Day 30: payment is 30 days past due. This is the reportable threshold under FCRA. A 30-day delinquency may be reported to Equifax, Experian, and TransUnion and will appear on your credit report. A single 30-day late payment can reduce a FICO score by 60-110 points depending on starting score.\n\nGrace period vs. deferment: A grace period is built into the loan agreement automatically. A deferment or forbearance is a temporary suspension of payments that must be applied for. Do not confuse the two.\n\nPractical use: If you are 12 days past due on a personal loan and within the grace period, you can make the payment before the grace period expires and avoid both a late fee and credit bureau reporting. If you cannot pay within the grace period, call the lender before the 30-day mark - many servicers will work out a short-term payment arrangement to avoid a credit bureau delinquency mark.",
    related: ["payment-grace-period", "credit-bureau", "late-fee", "forbearance"],
  },
  {
    slug: "introductory-rate",
    name: "Introductory Rate",
    aka: ["teaser rate", "promotional rate", "intro APR"],
    category: "Rates & terms",
    short: "A temporarily reduced interest rate offered for an initial period to attract new borrowers. Common on credit cards (0% APR for 12-21 months) and some HELOCs, but not on standard personal loans. When the introductory period ends, the rate adjusts to the standard (higher) rate.",
    long: "An introductory rate is a promotional interest rate that applies for a limited period at the start of a credit account or loan. After the introductory period expires, the rate resets to the ongoing standard rate, which is typically much higher.\n\nCredit card context (most common): 0% introductory APR offers on purchases: no interest for 12-21 months on new purchases. 0% introductory APR offers on balance transfers: no interest for 12-21 months on transferred balances, usually with a 3%-5% balance transfer fee. After the intro period: rate resets to the standard purchase APR, typically 20%-29.99%. Deferred interest variant: some retailer cards do not truly waive interest during the promo period - they accrue it and apply it all retroactively if the balance is not paid in full by the deadline. This is not 0% APR - it is deferred interest, and the difference can be significant.\n\nPersonal loan context: Standard personal loans do not have introductory rates - they carry a fixed APR from origination through payoff. However, some variable-rate personal loans (less common) may offer an initially lower rate that adjusts over time.\n\nHELOC context: Home equity lines of credit sometimes have a draw-period rate that is lower than the repayment-period rate. This is functionally a form of introductory rate for the draw period.\n\nBorrower strategy for credit card 0% offers: Useful for large purchases or debt consolidation if you can pay the balance in full before the intro period expires. Calculate: take the total balance, divide by the number of months in the intro period - if you can make those monthly payments, 0% APR is better than a personal loan. If not, a personal loan with a fixed lower rate for a longer term may be the better choice.",
    related: ["annual-percentage-rate", "balance-transfer", "variable-rate", "deferred-interest"],
  },
  {
    slug: "hard-pull-vs-soft-pull",
    name: "Hard Pull vs. Soft Pull",
    aka: ["hard inquiry vs. soft inquiry", "hard check vs. soft check"],
    category: "Credit",
    short: "A hard pull (hard inquiry) occurs when a lender requests your full credit report for a lending decision - it may lower your credit score by 5-10 points and stays on your report for 2 years. A soft pull is a background check for pre-qualification or employment verification - it has zero impact on your credit score.",
    long: "Hard and soft credit inquiries are the two types of records created when a party accesses your credit report. They differ in who sees them, how they affect your score, and when they occur.\n\nHard inquiries (hard pulls): When they occur: When you formally apply for credit - personal loans, mortgages, credit cards, auto loans, or some apartment applications. Who can see them: Lenders reviewing your credit report can see hard inquiries from the past 2 years. You can see them on your credit report. Score impact: A single hard inquiry typically reduces FICO scores by 5-10 points. The impact fades after 12 months and the inquiry disappears from the report after 24 months. Multiple inquiries: For the same type of loan (mortgage, auto, student loan, and now personal loans under newer FICO versions) inquiries within a 14-45 day window are 'deduplicated' and counted as one inquiry. Rate shopping for personal loans within this window is relatively safe.\n\nSoft inquiries (soft pulls): When they occur: Pre-qualification checks (when a lender checks if you might qualify without you formally applying). Employer background checks. Existing lender account reviews. You checking your own credit. Credit card pre-approval mailings. Who can see them: Only you see soft inquiries on your credit report. Lenders reviewing your credit cannot see soft pulls from other parties. Score impact: Zero. Soft pulls never affect credit scores.\n\nPre-qualification vs. pre-approval: Most lenders now offer a soft-pull pre-qualification that generates estimated rate offers. This is the correct first step when rate shopping - compare pre-qualification offers from multiple lenders without any credit score impact, then formally apply (hard pull) only with the best option.",
    related: ["credit-bureau", "fico-score", "pre-qualification", "rate-shopping"],
  },
  {
    slug: "loan-purpose",
    name: "Loan Purpose",
    aka: ["stated purpose", "use of funds"],
    category: "Application",
    short: "The stated reason for a personal loan - debt consolidation, home improvement, medical expenses, etc. Lenders ask for loan purpose on applications. While personal loans can be used for almost anything legal, the purpose affects underwriting (some lenders restrict certain uses) and may affect whether specific loan products are available.",
    long: "Loan purpose is the stated reason you are borrowing money. On personal loan applications, lenders typically ask you to select from a drop-down list of common purposes: debt consolidation, home improvement, medical expenses, wedding, vacation, vehicle, business, moving/relocation, or 'other.'\n\nDoes the lender verify loan purpose? Rarely for personal loans. Unlike a mortgage (where the funds are escrowed and paid directly to the seller) or an auto loan (where the lender pays the dealer directly), personal loan funds typically deposit into your bank account with no verification of how they are spent. However, lenders may ask for additional documentation for specific stated purposes.\n\nPurposes that may affect loan availability or terms: Business use: some personal loan lenders explicitly prohibit business use in their terms. If you are borrowing for a business purpose, check the lender's terms or use a business loan product. Real estate purchases (buying land or a home): lenders often exclude personal loans for real estate acquisition. Education: some lenders prohibit using personal loans for tuition, requiring borrowers to use student loan products instead. Investment accounts: most lenders prohibit using personal loan funds for investing in securities or cryptocurrency.\n\nPurposes that affect product availability: If your purpose is debt consolidation, some lenders will pay creditors directly rather than depositing funds. This adds administrative steps but reduces the risk you will spend the funds on something else. If your purpose is home improvement, you may qualify for a home improvement loan (sometimes at lower rates), or a HELOC if you have equity.\n\nWhy accuracy matters: Even if verification is rare, misrepresenting loan purpose may constitute loan fraud. Stating 'home improvement' when the funds will be used for a prohibited purpose like equity investing is a misrepresentation that could constitute fraud and void your loan agreement.",
    related: ["personal-loan-uses", "business-loan", "debt-consolidation-loan", "origination"],
  },
  {
    slug: "net-pay-vs-gross-pay",
    name: "Net Pay vs. Gross Pay",
    aka: ["take-home pay", "gross income vs. net income"],
    category: "Application",
    short: "Gross pay is your income before taxes and deductions. Net pay is what you actually receive after taxes, health insurance, retirement contributions, and other withholdings are deducted. Lenders use gross income for DTI calculations. Borrowers often use net pay when budgeting for monthly loan payments.",
    long: "Understanding the difference between gross and net pay is essential for accurately assessing loan affordability.\n\nGross income: Your total compensation before any deductions. Includes base salary, bonuses, commissions, overtime pay, and other forms of compensation. This is the number that appears on offer letters, pay stubs before deductions, and W-2 box 1 (wages, salaries, tips). Self-employed borrowers use gross revenue minus business expenses (Schedule C net income, or business net profit) as their qualifying income.\n\nNet income (take-home pay): What you actually receive in your bank account after: federal and state income tax withholding, FICA taxes (Social Security 6.2%, Medicare 1.45%), health insurance premiums, 401(k)/IRA contributions, other voluntary deductions. A common rule of thumb: net pay is approximately 65%-75% of gross pay for a middle-income W-2 employee, depending on tax bracket, state income tax, and benefit elections.\n\nWhat lenders use: Lenders calculate DTI using gross monthly income. If a lender says their maximum DTI is 43%, they mean your total monthly debt payments (including the new loan) cannot exceed 43% of your gross monthly income, not net. This matters because your gross is higher than your net, so the 43% threshold against gross income leaves less room for debt than it might appear.\n\nWhat you should use for budgeting: Use your net income (actual take-home pay) for budgeting analysis. Can you genuinely afford the new monthly loan payment on what actually hits your bank account each month? Rule of thumb: your total monthly debt payments (all loans + minimum credit card payments) should not exceed 35%-40% of your net take-home pay to leave room for housing, food, transportation, and savings.",
    related: ["debt-to-income-ratio", "income-verification", "income-to-debt-ratio"],
  },
  {
    slug: "accrued-interest",
    name: "Accrued Interest",
    aka: ["earned interest", "interest accrual"],
    category: "Rates & terms",
    short: "Accrued interest is the amount of interest that has built up on a loan since the last payment was made but has not yet been paid or collected. On a personal loan, interest accrues daily based on the outstanding principal balance and the daily periodic rate.",
    long: "Interest accrues continuously on most personal loans, even though payments are made monthly. Understanding accrual helps borrowers see exactly what they owe between billing cycles and why the exact payoff amount changes from day to day.\n\nHow daily accrual works: Divide your annual interest rate (APR) by 365 to get the daily periodic rate. Multiply that by your current principal balance. That dollar figure is the interest accruing every day you carry the loan. Example: a $10,000 balance at 18% APR accrues approximately $4.93 per day ($10,000 x 0.18 / 365).\n\nWhen you make a monthly payment, the lender first applies it to accrued interest since the last payment, then applies the remainder to principal. Early in the loan term, a larger share of each payment goes to interest (since the principal is higher); later, more goes to principal. This is standard amortization.\n\nPayoff amounts: If you request a payoff quote, the lender calculates the current principal plus all accrued but unpaid interest up to the payoff date, plus any fees. The payoff amount increases each day you wait. Always ask for a payoff quote valid through the specific date you plan to send the final payment.\n\nIf you miss a payment: Interest continues to accrue on the full balance during delinquency. Some lenders also charge a late fee. If interest is never paid, it may eventually be capitalized (added to principal), causing the balance to grow.\n\nPrepayment consideration: When you make extra principal payments, you reduce the balance on which future interest accrues, which saves money on the total interest paid over the life of the loan.",
    related: ["annual-percentage-rate", "amortization", "prepayment-penalty", "interest-capitalization"],
  },
  {
    slug: "deferred-payment",
    name: "Deferred Payment",
    aka: ["payment deferral", "skip-a-payment", "deferred start"],
    category: "Repayment",
    short: "A deferred payment is a scheduled loan payment that has been postponed to a later date, either as a promotional feature at origination or as a hardship accommodation mid-loan. Interest typically continues to accrue during the deferral period even though no payment is due.",
    long: "Payment deferral can appear in two distinct contexts: an origination perk offered by lenders to attract borrowers, or a mid-loan accommodation for borrowers facing temporary hardship.\n\nOrigination deferral (promotional): Some lenders offer a 30, 45, or 60-day delay before the first payment is due. This sounds appealing but means interest accrues from funding date even though you are not yet paying. By the time your first payment arrives, you may already owe more than just one month of interest. Always calculate the total cost difference before accepting a deferred-start offer.\n\nMid-loan deferral (hardship accommodation): If you lose a job, face a medical emergency, or experience another financial shock, many lenders will grant a one- or two-month payment deferral. During this period, the payment due is $0. However, interest usually continues to accrue on the full principal. The deferred payment (and its accrued interest) is tacked onto the end of the loan, extending the term.\n\nKey distinctions: Deferral is different from forbearance (which typically involves a formal agreement under the federal definition, more common in student and mortgage lending). Deferral is also different from loan modification (which may permanently change the rate or term). For personal loans, deferral is usually an informal lender policy, not a federally mandated right.\n\nCredit impact: A properly granted deferral should not harm your credit score because payments are marked as current during the approved period. However, unauthorized skipped payments (missing a payment without formal deferral approval) will be reported as late and damage your score after 30 days.\n\nCost: Deferral is not free. The interest that accrues during the deferral period is real money added to your total loan cost. Use deferral as an emergency tool, not a routine financial strategy.",
    related: ["forbearance", "loan-modification", "accrued-interest", "payment-grace-period"],
  },
  {
    slug: "non-sufficient-funds",
    name: "Non-Sufficient Funds (NSF)",
    aka: ["NSF fee", "returned payment fee", "bounced payment"],
    category: "Repayment",
    short: "Non-sufficient funds (NSF) occurs when a borrower's bank account does not have enough money to cover a scheduled loan payment. The payment is returned unpaid, and both the bank and lender may charge fees. Repeated NSF events can trigger late fees, penalty rates, and negative credit reporting.",
    long: "NSF is one of the most avoidable loan costs, yet it catches many borrowers off guard, especially those who use autopay and do not monitor their checking balance carefully.\n\nWhat happens step by step: On the scheduled payment date, the lender submits an ACH debit to your bank. If your balance is below the payment amount, the bank rejects the transaction and returns it marked 'NSF.' The lender receives the returned payment notice, typically within 1-3 business days. Both parties may charge fees at this point.\n\nTypical fees: Your bank usually charges an NSF fee of $25-$35. The lender typically charges a returned-payment fee of $15-$50 (varies by lender and state law). Some states cap NSF fees or prohibit them entirely. Check your loan agreement for the exact returned-payment fee.\n\nWhat happens next: The lender may re-attempt the ACH debit (some retry once or twice automatically within a few days). If the payment remains uncollected, the account becomes delinquent. After 30 days of non-payment, the lender typically reports the account as late to the credit bureaus. If the account goes 90 or more days without payment, the lender may charge off the loan.\n\nCredit impact: An NSF event alone does not hurt your credit score if you fix the payment before the 30-day reporting threshold. The credit damage comes from the resulting delinquency, not the NSF itself.\n\nHow to prevent NSF: Link a savings account as overdraft protection. Set a low-balance alert for the day before your autopay date. Keep a buffer of at least one full loan payment in your checking account. If you know a payment will fail, contact the lender before the due date, not after.",
    related: ["payment-grace-period", "late-fee", "charge-off", "autopay-discount"],
  },
  {
    slug: "payday-loan",
    name: "Payday Loan",
    aka: ["payday advance", "cash advance loan", "check advance"],
    category: "Lender types",
    short: "A payday loan is a small, short-term loan (typically $100-$1,500) due in full on the borrower's next payday, usually in 2-4 weeks. They carry extremely high effective APRs, often 300%-600% or more, and are frequently cited as a debt trap for borrowers who cannot repay in full and must roll over the loan.",
    long: "Payday loans are among the most expensive forms of credit available to consumers, and understanding their structure helps borrowers recognize when a personal loan is a dramatically better alternative.\n\nHow they work: You write a post-dated check (or authorize an ACH debit) to the lender for the loan amount plus a fee. The lender gives you cash or a bank transfer for the loan amount now. On your next payday (2-4 weeks later), the lender deposits the check or pulls the ACH. If you cannot cover it, you can roll the loan over by paying another fee, extending the due date by another 2-4 weeks.\n\nThe real cost: A $15 fee on a $100 two-week loan looks small in dollar terms. But annualized: ($15 / $100) x (365 / 14) = 391% APR. This is not an edge case. The Consumer Financial Protection Bureau (CFPB) reports that the typical payday borrower is in debt for 5 months of the year, paying $520 in fees to borrow $375.\n\nRollover trap: Approximately 80% of payday loans are rolled over or renewed within 14 days, per CFPB data. Each rollover costs another fee. A $300 loan rolled over 5 times can easily cost more in fees than the original principal.\n\nState regulation: Payday lending is banned or heavily restricted in approximately 18 states. Many others cap fees or limit rollovers. Some states require installment repayment instead of a single balloon payment.\n\nAlternatives: A personal loan from a bank or online lender at 15%-36% APR is dramatically cheaper, even if the rate feels high. Credit unions offer payday alternative loans (PALs) capped at 28% APR. Buy-now-pay-later installment plans and employer-based paycheck advances can also be lower-cost options.",
    related: ["annual-percentage-rate", "usury-law", "predatory-lending", "buy-now-pay-later"],
  },
  {
    slug: "cosigner",
    name: "Cosigner",
    ...
    category: "Application",
    short: "A cosigner is a person who signs a loan agreement alongside the primary borrower and is equally responsible for repaying the debt. Lenders accept cosigners when the primary borrower's credit or income is insufficient to qualify alone. Unlike a co-borrower, the cosigner typically does not receive or use the loan proceeds.",
    long: "A cosigner provides their creditworthiness as additional assurance to the lender. If the primary borrower stops paying, the lender can pursue the cosigner for the full balance, including principal, interest, fees, and collection costs.\n\nHow it helps borrowers: If your credit score is too low or your income too limited to qualify, adding a cosigner with strong credit and income can get the loan approved, often at a substantially lower interest rate. The cosigner's credit profile supplements yours in the lender's underwriting model.\n\nHow it affects the cosigner: The loan appears on the cosigner's credit report as an open liability. It increases their DTI ratio, which can affect their ability to get their own loans (mortgage, car loan) while your loan is outstanding. Every late payment or missed payment by the primary borrower also damages the cosigner's credit score. The cosigner is taking on real financial and credit risk.\n\nCosigner vs. co-borrower: A cosigner is a fallback guarantor who is not using the loan proceeds. A co-borrower jointly receives and uses the funds (e.g., a couple taking out a home improvement loan together). Both appear on the loan and are equally liable for repayment, but co-borrowers typically have more stake in the loan purpose.\n\nCosigner release: Some lenders allow cosigner release after a certain number of on-time payments (typically 12-24 months), proving the primary borrower can handle the debt alone. Not all lenders offer this. Check before you sign whether release is possible and what the requirements are.\n\nRisk to relationships: Defaulting on a cosigned loan can permanently damage a personal relationship, in addition to the financial and credit consequences. Cosigning is a serious legal commitment, not a formality.",
    related: ["co-borrower", "debt-to-income-ratio", "credit-score", "income-verification"],
  },
  {
    slug: "loan-maturity",
    name: "Loan Maturity",
    aka: ["maturity date", "loan end date", "final payment date"],
    category: "Rates & terms",
    short: "Loan maturity is the date on which the final payment is due and the loan is fully repaid. At maturity, the outstanding principal balance reaches zero. Personal loans typically mature in 1-7 years. Paying off a loan before its maturity date is called prepayment.",
    long: "Every loan has a maturity date established at origination. For a standard amortizing personal loan, this is simply the date of the final scheduled monthly payment if all payments are made on time and no extra payments are made.\n\nMaturity vs. term: The loan term is the length of time from funding to maturity. A 36-month personal loan funded on June 1, 2026 matures on June 1, 2029. Longer terms mean lower monthly payments but more total interest paid over the life of the loan.\n\nWhat happens at maturity: On the maturity date, the final scheduled payment is due. This payment typically includes the last month's interest plus any remaining principal. If the loan has been paid ahead of schedule (extra payments), the final payoff may come before the maturity date, and the outstanding balance at that point is the actual payoff amount.\n\nBalloon maturity: Some loan structures have a balloon payment at maturity, meaning most of the principal is due in a large lump sum at the end rather than being amortized evenly. Most standard personal loans are fully amortizing and do not have balloon payments.\n\nExtended maturity (hardship): If a lender grants a payment deferral or modification, the maturity date is typically extended by the same number of deferred months. The loan does not simply forgive those payments; it pushes the end date out.\n\nCredit report impact: Once a loan reaches maturity and is paid in full, it is marked 'closed' and 'paid as agreed' on your credit report. Closed accounts in good standing continue to positively influence your credit history for up to 10 years.",
    related: ["loan-term", "amortization", "balloon-payment", "prepayment-penalty"],
  },
  {
    slug: "interest-capitalization",
    name: "Interest Capitalization",
    aka: ["capitalizing interest", "compounding unpaid interest"],
    category: "Rates & terms",
    short: "Interest capitalization occurs when unpaid or accrued interest is added to the outstanding principal balance of a loan. Once capitalized, that interest begins accruing additional interest itself, increasing the total cost of the loan beyond the original principal.",
    long: "Capitalization is the mechanism by which interest-on-interest (compound interest) can silently inflate a loan balance. It is especially important to understand in personal loans with deferred payment periods or during forbearance.\n\nHow it works: Suppose you defer two months of payments on a $10,000 personal loan at 18% APR. During those two months, approximately $298 of interest accrues. If the lender capitalizes this interest, the new principal balance becomes $10,298. Going forward, all future interest calculations are based on $10,298, not $10,000. This increases every future payment slightly and adds to the total interest you will pay over the remaining term.\n\nWhen capitalization occurs: Capitalization can happen at the end of a grace or deferral period, after a forbearance ends, when missed payments are formally added to the balance, or at other contractual trigger points defined in the loan agreement.\n\nPersonal loan vs. student loan context: Capitalization is most aggressively discussed in student loan contexts, where interest can accrue for years during in-school deferment. For personal loans, which typically have shorter terms and no in-school periods, capitalization events are less frequent and the dollar impact is smaller but still real.\n\nHow to minimize it: Pay interest-only if allowed during any deferral period. Make payments before the capitalization trigger date when possible. If choosing between forbearance and deferral options, ask the lender whether and when unpaid interest will be capitalized.\n\nCheck your loan agreement: The promissory note or loan agreement should specify whether and when the lender capitalizes unpaid interest. If it is unclear, ask before accepting any deferral or modification offer.",
    related: ["accrued-interest", "deferred-payment", "amortization", "forbearance"],
  },
  {
    slug: "mixed-credit-file",
    name: "Mixed Credit File",
    aka: ["commingled file", "credit file mix-up"],
    category: "Credit",
    short: "A mixed credit file occurs when a credit bureau combines information from two or more different consumers into a single report, usually because they share similar names, addresses, Social Security numbers, or other identifying information. The result can be inaccurate credit scores and unjust loan denials.",
    long: "Mixed files are one of the more serious credit reporting errors because they introduce another person's debt history, payment patterns, and possibly public records into your credit report without your knowledge.\n\nCommon causes: Consumers with the same or very similar names (particularly fathers and sons sharing a name, or people with common surnames), consumers who have lived at the same address at different times, and errors in Social Security number transcription (a single digit transposition can merge two strangers' files) are the most frequent sources.\n\nHow to detect it: Review your credit reports from all three bureaus (Equifax, Experian, TransUnion) at AnnualCreditReport.com annually. Look for: accounts you do not recognize, addresses where you have never lived, employers you have never worked for, inquiries from lenders you never contacted, or names that are not yours.\n\nImpact on loan applications: If a mixed file contains negative information (late payments, collections, judgments) belonging to someone else, your credit score will be artificially suppressed. You may be denied a personal loan or offered a higher rate based on another person's credit behavior.\n\nHow to dispute: File a dispute directly with each credit bureau that has the mixed file. You can dispute online, by mail, or by phone. Under the Fair Credit Reporting Act (FCRA), bureaus must investigate within 30 days and correct or remove inaccurate information. Send certified mail with return receipt for documentation. Include a copy of your ID and any proof of the error.\n\nFCRA rights: You have the right to have inaccurate information corrected, to add a 100-word statement of explanation to your file, and to request that corrected reports be sent to any lender who pulled your file in the past 6 months.",
    related: ["credit-report", "dispute-process", "fair-credit-reporting-act", "identity-theft"],
  },
  {
    slug: "debt-avalanche",
    name: "Debt Avalanche",
    aka: ["highest-rate-first payoff", "avalanche method"],
    category: "Repayment",
    short: "The debt avalanche is a repayment strategy in which a borrower pays minimum amounts on all debts and directs all extra money toward the debt with the highest interest rate first. Once that balance is eliminated, the freed-up payment is added to the next-highest-rate debt. This method minimizes the total interest paid over time.",
    long: "The debt avalanche is the mathematically optimal debt payoff strategy. By targeting the highest APR debt first, you reduce the rate at which interest accrues across your entire debt portfolio as quickly as possible, saving the most money.\n\nHow it works: List all debts by interest rate, highest to lowest. Make minimum payments on all accounts every month. Take any extra money available for debt repayment and apply it entirely to the highest-rate balance. Once that debt is paid off, add its former minimum payment (plus the extra) to the next-highest-rate balance. Continue until all debts are paid.\n\nExample: You have a $5,000 personal loan at 20% APR and a $3,000 credit card at 28% APR. Avalanche tells you to target the credit card first (higher rate), even though it has a smaller balance. Once the card is paid off, roll that full payment into the personal loan.\n\nAvalanche vs. snowball: The debt snowball targets the smallest balance first for psychological wins. The avalanche targets the highest rate first for mathematical efficiency. Studies consistently show the avalanche saves more money in total interest. However, the snowball can be more motivating for people who struggle with consistency. The best method is the one you will actually stick with.\n\nWhen to use avalanche: If you are disciplined and motivated by numbers rather than quick wins, the avalanche maximizes savings. It is especially powerful when the rate differential between debts is large (e.g., a 29% credit card vs. a 10% personal loan).\n\nPersonal loan refinancing angle: If you can consolidate high-rate debts into a lower-rate personal loan, you automatically implement a form of the avalanche by reducing your blended interest rate across all balances simultaneously.",
    related: ["debt-snowball", "debt-consolidation-loan", "annual-percentage-rate", "debt-to-income-ratio"],
  },
  {
    slug: "debt-snowball",
    name: "Debt Snowball",
    aka: ["smallest-balance-first payoff", "snowball method"],
    category: "Repayment",
    short: "The debt snowball is a repayment strategy where a borrower pays minimums on all debts and targets the smallest balance first, regardless of interest rate. Once the smallest debt is eliminated, the full payment rolls to the next smallest. It prioritizes psychological momentum over mathematical efficiency.",
    long: "The debt snowball was popularized by personal finance educator Dave Ramsey and has substantial real-world success, particularly for borrowers who have struggled to maintain consistent repayment habits.\n\nHow it works: List all debts by balance, smallest to largest. Make minimum payments on all accounts every month. Direct all extra money toward the smallest balance. When that debt is paid off, add its entire former minimum payment to the minimum payment on the next-smallest balance. Repeat until all debts are cleared.\n\nWhy it works psychologically: Paying off a small debt completely delivers a clear, tangible victory. That sense of progress is motivating. Research in behavioral economics (notably by Kellogg professor David Gal and Blakeley McShane) shows that eliminating individual accounts - not just reducing balances - is particularly motivating for debtors and increases the probability of sticking with a repayment plan.\n\nCost vs. avalanche: The snowball typically costs more in total interest than the debt avalanche because you may carry high-rate balances longer. The difference can be hundreds or thousands of dollars depending on the balances and rates involved. For someone who previously failed at debt payoff, the higher cost may be worth the improved consistency.\n\nWhen to use snowball: If you have several small debts with manageable interest rates, the snowball's efficiency penalty is small. If you are returning to debt repayment after previous failures, the quick wins may help you build lasting habits. If all your debts have similar rates, the snowball and avalanche produce nearly identical results.\n\nHybrid approach: Some borrowers target a small, quickly payable balance first for an initial win, then switch to highest-rate-first targeting. This hybrid approach can balance motivation and mathematical efficiency.",
    related: ["debt-avalanche", "debt-consolidation-loan", "minimum-payment", "debt-to-income-ratio"],
  },
];
