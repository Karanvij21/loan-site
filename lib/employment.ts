...
export const employmentTypes: Record<string, UseCase> = {
  ...
  "rideshare-drivers": {
    ...
    h1: "Personal Loans for Rideshare Drivers: Uber, Lyft & DoorDash (2026)",
    title: "Personal Loans for Rideshare Drivers (2026): Uber & Lyft Income Guide",
    description: "Personal loan options for Uber, Lyft, and DoorDash drivers. How to document gig income, which lenders accept 1099 income, and rates from 9.99% APR in 2026.",
    eyebrow: "Rideshare driver loans",
    intro: "Rideshare and gig platform drivers receive 1099 income, not W-2s, which complicates personal loan applications. However, with proper documentation - primarily tax returns and bank statements - gig workers with consistent income and good credit qualify at most major lenders. The key is showing 2 years of stable earnings.",
    amountMin: 1000,
    amountMax: 30000,
    termMin: 12,
    termMax: 60,
    ...
    aprMax: 35.99,
    bullets: [
      "1099 income from Uber, Lyft, DoorDash, and similar platforms accepted",
      "Provide 2 years of tax returns plus recent bank statements",
      "Net Schedule C profit (after business expenses) is the qualifying income",
      "Credit unions may offer more flexibility on gig income documentation",
      "Vehicle maintenance costs are deductible, which may reduce qualifying income",
    ],
    faqs: [
      { q: "How do rideshare drivers document income for a personal loan?", a: "Lenders need to verify consistent income over time. As a rideshare driver, you will typically provide: (1) Two years of federal tax returns (1040 with Schedule C). The net profit from Schedule C is your qualifying income - not gross earnings. (2) Two to three months of bank statements showing regular deposits from Uber, Lyft, or other platforms. (3) 1099-NEC or 1099-K forms from the gig platforms (Uber and Lyft issue these if you earned over $600/year). Some lenders may also ask for YTD earnings statements from the platform's driver dashboard - Uber, Lyft, and DoorDash all have earnings dashboards that show weekly and monthly income history that you can screenshot or export." },
      { q: "Will my vehicle deductions reduce the income lenders see?", a: "Yes. If you deduct vehicle miles, maintenance, phone, and other business expenses on Schedule C, your net profit is lower than gross earnings. Example: $60,000 gross rideshare earnings with $25,000 in vehicle and business expenses = $35,000 net profit, which is your qualifying income. This is the most common challenge for rideshare drivers. Options: (1) Use the standard mileage rate instead of actual expenses (50%-55% of standard mileage deduction can be lower than actual expenses, resulting in higher net income for some drivers). (2) Use a bank statement lender (based on deposit history rather than tax returns). (3) Apply with a co-borrower whose W-2 income supplements your 1099 income." },
      { q: "Can I use a personal loan to buy a car for rideshare driving?", a: "You can use a personal loan to buy any vehicle - however, auto loans typically offer lower rates (5%-12% APR) for purchasing a vehicle than unsecured personal loans (9%-25% APR). If the vehicle will serve as collateral, an auto loan from a credit union or online auto lender is almost always a cheaper option. The advantage of a personal loan for a car purchase is that it works for older vehicles (typically over 10 years old or over 150,000 miles) that many auto lenders will not finance. For private-party purchases where the seller needs fast payment, a personal loan can also be funded faster than some dealer financing arrangements." },
    ],
  },
  "freelancers": {
    slug: "freelancers",
  ...
  "stay-at-home-parents": {
    ...
    h1: "Personal Loans for Stay-at-Home Parents: Options & Income Tips (2026)",
    title: "Personal Loans for Stay-at-Home Parents (2026): Spousal Income & Approval",
    description: "How stay-at-home parents can qualify for personal loans using spousal income. Federal regulations require lenders to consider household income. Rates from 9.99% APR in 2026.",
    eyebrow: "Stay-at-home parent loans",
    intro: "Stay-at-home parents often assume they cannot qualify for personal loans without their own income. In reality, a 2013 Consumer Financial Protection Bureau rule update specifically requires credit card issuers - and by interpretation, personal lenders - to consider household income, not just individual income. Married stay-at-home parents can often qualify using a spouse's or partner's income with proper documentation.",
    amountMin: 1000,
    amountMax: 35000,
    termMin: 12,
    termMax: 60,
  ...
  "veterans": {
    ...
    aprMax: 25,
    bullets: [
      "USAA membership is open to veterans and their families - personal loan rates are competitive with top online lenders",
      "Navy Federal Credit Union (NFCU) serves veterans and offers personal loans up to $50,000 with rates starting at 8.99% APR",
      "SoFi offers specific rate discounts for military members and veterans in recognition of service",
      "Veterans are NOT covered by MLA's 36% MAPR cap (only active duty and their dependents are protected)",
      "VA home loan entitlement is a separate benefit - does not affect personal loan access but may be relevant for home-related needs",
      "PTSD and medical-related loan needs: some CDFIs and nonprofits offer targeted assistance for veterans in financial hardship",
    ],
    faqs: [
      { q: "Can veterans get special rates on personal loans?", a: "At USAA and Navy Federal Credit Union, membership is exclusive to military personnel and their families, which means the rates reflect a pool of lower-risk borrowers with stable income and strong credit habits. These institutions often offer rates competitive with or better than mainstream online lenders. SoFi and several other lenders offer explicit veteran discounts (typically 0.25%-0.50% rate reduction). Always ask any lender whether they offer military or veteran rate discounts, as not all advertise them prominently." },
      { q: "Is the Military Lending Act (MLA) protection available to veterans?", a: "No. The MLA protects active duty servicemembers, National Guard and Reserve members on active duty, and their covered dependents. Once a servicemember separates or retires, MLA protections no longer apply. This means veterans do not have the 36% MAPR cap that active duty members receive. Veterans should compare lenders carefully and specifically use military-focused institutions (USAA, NFCU) that tend to offer fair terms even without the MLA mandate." },
      { q: "What are the best personal loan options for veterans with bad credit?", a: "Veterans with damaged credit (often from financial challenges during or after transition) have a few specialized options. NFCU and USAA may have more flexibility for members with lower credit scores due to relationship-based lending. State-level veterans affairs offices sometimes run emergency financial assistance programs. VSO (Veterans Service Organization) financial assistance programs (DAV, VFW, American Legion) provide grants or low-interest emergency loans to qualifying veterans. For larger amounts, a secured personal loan using a car title or savings account as collateral improves approval odds when credit scores are low." },
    ],
  },
  "part-time-workers": {
    slug: "part-time-workers",
    h1: "Personal Loans for Part-Time Workers: What You Need to Qualify",
    title: "Personal Loans for Part-Time Workers (2026): Approval Guide",
    description: "Part-time income qualifies for personal loans at most lenders. Here's how to document hours, calculate qualifying income, and get approved with a part-time salary.",
    eyebrow: "Part-Time Workers",
    intro: "Part-time employment income qualifies for personal loans - lenders care about total income and stability, not whether you work 20 or 40 hours per week. The challenge for part-time workers is demonstrating income consistency when hours may vary week-to-week. Providing 3-6 months of pay stubs (to show a consistent earnings history) and W-2s or tax returns (to show annual totals) helps lenders calculate your qualifying income accurately. Part-time workers who have held the same position for 12+ months are viewed more favorably than those with recent job changes.",
    amountMin: 1000,
    amountMax: 35000,
    termMin: 12,
    termMax: 60,
    ...
    aprMax: 30,
    bullets: [
      "Part-time income is accepted by all major personal loan lenders when documented with pay stubs and tax returns",
      "Variable-hour workers: lenders may average 12-24 months of income to determine qualifying income",
      "Multiple part-time jobs: all jobs' income can be combined if each can be documented separately",
      "Job stability matters: 12+ months at the same employer(s) strengthens the application",
      "DTI calculation uses annualized income - all income sources counted, so additional freelance or side income helps",
      "Credit score requirements are the same as for full-time workers - score is evaluated independently",
    ],
    faqs: [
      { q: "Do lenders treat part-time income differently than full-time income?", a: "Yes, in one important way: variable hours. If your weekly hours are consistent (you regularly work 24 hours per week at the same rate), lenders treat this as stable income similar to full-time. If hours vary significantly week to week (10 hours one week, 32 the next), lenders typically average your income over 12-24 months to determine a reliable baseline. This means your qualifying income is the average, not the peak. Providing 12+ months of pay stubs is especially valuable for variable-hour workers to demonstrate a consistent earnings history." },
      { q: "Can I combine multiple part-time jobs to qualify for a larger loan?", a: "Yes. Lenders will include income from all documented employment sources. If you work two part-time jobs, provide pay stubs and W-2s (or 1099s) from both. Each income stream must be documentable and demonstrated to have at least 12 months of history (or a reasonable expectation of continuing). Recent new jobs (under 6-12 months old) are sometimes excluded from the qualifying income calculation at more conservative lenders because there is insufficient history to confirm stability." },
      { q: "What is the minimum income for a personal loan as a part-time worker?", a: "Most personal loan lenders have minimum annual income requirements of $12,000-$20,000. For a part-time worker earning $15/hour at 20 hours/week: $15 x 20 x 52 = $15,600 annually - right around the minimum threshold for many lenders. Additional income (side gigs, alimony, rental income) can supplement and help meet minimums. Smaller loan amounts ($1,000-$5,000) have lower effective income requirements because the resulting DTI is manageable at lower income levels. Avoid applying for amounts where the monthly payment would represent more than 20%-25% of your monthly income." },
    ],
  },
  "union-workers": {
    slug: "union-workers",
    eyebrow: "Employment type",
    h1: "Personal Loan for Union Workers",
    title: "Personal Loan for Union Workers: Benefits, Rates, and Best Lenders in 2026",
    description: "Union members often have strong borrowing power due to collectively bargained wages, benefits, and job security. Learn which lenders value union employment and how to maximize your loan terms.",
    intro: "Union membership signals stable employment, collectively bargained wages, and strong job security to lenders - all factors that improve personal loan eligibility and rates. Many credit unions were founded specifically to serve union members and offer the most competitive rates for this borrower profile.",
    amountMin: 2000,
    amountMax: 50000,
    termMin: 12,
    termMax: 84,
    ...
    aprMax: 22,
    bullets: [
      "Union wages are typically predictable and documented through collective bargaining agreements (CBAs)",
      "Union-affiliated credit unions (AFSCME, IBEW, Teamsters, UAW) offer lowest rates for members",
      "Union employment demonstrates strong job security - a positive underwriting signal",
      "Union benefit packages often include group life insurance, pension, and healthcare that reduce financial fragility",
      "Stricter layoff rules and seniority protections mean union workers are less likely to lose income suddenly",
      "Many unions have member assistance programs that can supplement or replace borrowing in emergencies",
      "International Brotherhood of Electrical Workers (IBEW) and United Auto Workers (UAW) credit unions available nationally",
      "Union pay stubs and CBAs are strong income documentation - easy to verify for lenders",
    ],
    faqs: [
      { q: "Do union workers get better personal loan rates?", a: "Often yes, especially at union-affiliated credit unions. Credit unions founded by specific unions (IBEW Credit Union, UAW-based credit unions, SEIU member credit unions) exist to serve their members and often offer rates 1%-3% below what mainstream banks offer for the same borrower profile. Union employment is viewed positively by underwriters because it implies stable income, layoff protections, and strong benefit packages that reduce financial vulnerability. Mainstream online lenders do not specifically price for union status, but they use income stability as a factor, which union employment supports." },
      { q: "Does my union have a credit union or financial assistance program?", a: "Many large unions maintain affiliated credit unions or financial programs. Check with your union's local or national office. Examples: IBEW (International Brotherhood of Electrical Workers): IBEW local-affiliated credit unions across the US. UAW: multiple UAW-affiliated credit unions especially in the Midwest. AFSCME (American Federation of State, County, Municipal Employees): AFSCME Financial Services. Teamsters: Teamsters-affiliated credit unions in many regions. Many unions also maintain emergency funds or hardship assistance programs for members facing specific crises - these provide grants or zero-interest loans that should be explored before a commercial personal loan." },
      { q: "How should I document union income for a personal loan application?", a: "Union income documentation is typically straightforward: Pay stubs (last 30-90 days): showing gross wages, union dues deducted, and take-home pay. W-2 forms (last 1-2 years): confirming annual earnings. If your union has variable overtime or shift differential pay, lenders may ask for 12-24 months of pay stubs to calculate the average. Collective bargaining agreement (CBA): some lenders, especially credit unions, accept the CBA as evidence of wage and employment stability because it demonstrates the contractual wage for your job classification. Letter from union hall or employer confirming employment and wage classification can supplement pay stubs." },
    ],
  },
  "tipped-workers": {
    slug: "tipped-workers",
    eyebrow: "Employment type",
    h1: "Personal Loan for Tipped Workers",
    title: "Personal Loan for Tipped Workers: How to Document Income and Qualify in 2026",
    description: "Servers, bartenders, and other tipped workers face unique income documentation challenges for personal loans. Learn how to properly document tip income, which lenders are most flexible, and how to maximize your qualifying income.",
    intro: "Tipped workers often earn significantly more than their base wage but face challenges documenting total income for loan applications. With proper documentation, tipped income is fully qualifying - lenders can and must consider it under ECOA. The key is having the right paperwork.",
    amountMin: 1000,
    amountMax: 25000,
    termMin: 12,
    termMax: 60,
    ...
    aprMax: 30,
    bullets: [
      "Tipped income counts as qualifying income under ECOA if it can be documented",
      "W-2 box 1 includes reported tips - this is the primary documentation for reported tip income",
      "Unreported cash tips cannot be used as qualifying income (no documentation trail)",
      "Bank deposits showing consistent tip income can supplement W-2s at flexible lenders",
      "IRS Form 4137 (Social Security Tax on Unreported Tips) demonstrates some unreported tips were claimed",
      "Total income matters: a server earning $45,000/year including tips qualifies like any $45,000 earner",
      "Seasonal or variable income (busy vs. slow season) may be averaged over 12-24 months",
      "Tax returns (Schedule 1 or 1040) showing total income including tips are strong documentation",
    ],
    faqs: [
      { q: "How do tipped workers prove their income for a loan?", a: "The most accepted documentation for tipped income: W-2 forms: Box 1 of your W-2 includes wages and reported tips combined. This is the most lender-friendly documentation. Tax returns (1040): Line 1 shows total wages including tips. If you filed a Schedule H or Form 4137, this shows additional tip reporting. Bank statements: 12-24 months of bank deposits demonstrating consistent monthly income, even if the source is cash tips. Some lenders accept this for near-prime borrowers. Employer letter: A letter from your employer confirming your employment, average shifts per week, and estimated weekly tip income - useful as a supplement. The challenge: if you have historically underreported tip income on your taxes, your documented income is lower than your actual income. Lenders can only use what is documented." },
      { q: "Can I get a personal loan if I have mostly cash tips?", a: "Possibly, depending on the lender and your credit profile. Lenders that accept bank statement income verification (rather than only W-2s and tax returns) can use consistent bank deposits as proof of income, even if those deposits came from cash tips. This approach is more common at flexible near-prime lenders (Avant, Upgrade) and credit unions with manual underwriting. Mainstream prime lenders (SoFi, Lightstream, Marcus) typically require W-2 or tax return documentation. If your bank deposits show $3,500/month consistently over 12 months, a bank-statement-friendly lender may use that as your qualifying income." },
      { q: "What is the minimum credit score for a tipped worker to qualify for a personal loan?", a: "Credit score requirements are the same for tipped workers as any other borrower - your employment type does not change the credit score requirements. The minimum credit score varies by lender: SoFi: 680+. Avant: 580+. Upgrade: 580+. OneMain Financial: no stated minimum, manual review. For tipped workers who have inconsistent documented income, a higher credit score (680+) compensates for income documentation challenges - it gives lenders confidence in repayment even if income documentation is imperfect. Below 620, both income documentation AND credit score create compounding challenges. Focus on improving one (ideally credit score, since it is faster to move in 90 days) before applying." },
    ],
  },
};
