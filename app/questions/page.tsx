...
export const metadata: Metadata = {
  title: "Personal Loan FAQ: 168 Quick Answers (2026)",
  description:
    "168 short answers to common personal-loan questions: credit scores, approval odds, APRs, the process, special situations, and borrower types. Updated June 2026.",
