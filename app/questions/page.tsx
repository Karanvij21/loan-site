...
export const metadata: Metadata = {
  title: "Personal Loan FAQ: 288 Quick Answers (2026)",
  description:
    "288 short answers to common personal-loan questions: credit scores, approval odds, APRs, the process, special situations, and borrower types. Updated June 2026.",
