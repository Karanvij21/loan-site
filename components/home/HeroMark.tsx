    ...
    >
      <defs>
        <pattern id="dots" x="0" y="0" width="8" height="8" patternUnits="userSpaceOnUse">
          <circle cx="1" cy="1" r="1" fill="#1A3A2D" opacity="0.18" />
        </pattern>
      </defs>

      {/* Outer ring with dotted texture */}
      <circle cx="120" cy="120" r="118" stroke="#DFD3BB" strokeWidth="1" />
      <circle cx="120" cy="120" r="100" fill="url(#dots)" />

      {/* Inner forest disc */}
      <circle cx="120" cy="120" r="68" fill="#1A3A2D" />
      ...
      <text fontSize="9" fontFamily="var(--font-sans, sans-serif)" fill="#4A4640" letterSpacing="2.5">
