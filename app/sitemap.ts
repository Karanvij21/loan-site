...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const core: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/es/loans/personal`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/es/loans/bad-credit`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/es/loans/emergency`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/es/how-it-works`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/es/faq`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/es/apply`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/es/disclosures`, lastModified: now, changeFrequency: "yearly", priority: 0.4 },
