...
export const useCases: Record<string, UseCase> = {
  ...
  "bathroom-remodel": {
    ...
    h1: "Personal Loans for Bathroom Remodels: 2026 Rates & Financing Guide",
    title: "Personal Loan for Bathroom Remodel (2026): Rates from 7.99% APR",
    description: "Finance a bathroom remodel with a personal loan. Compare rates 7.99%-25% APR, typical project costs $6,000-$35,000, and best lenders for 2026 home improvement financing.",
    eyebrow: "Bathroom remodel financing",
    intro: "Bathroom renovations consistently rank among the highest-ROI home improvement projects. A mid-range bathroom remodel costs $10,000-$25,000 and returns 60%-80% of cost at resale. A personal loan is a fast, lien-free way to finance the project, with funds available in 1-5 business days after approval.",
    amountMin: 3000,
    amountMax: 35000,
    termMin: 12,
    termMax: 60,
  ...
  "solar-panels": {
    ...
    aprMax: 20,
    bullets: [
      "Federal Solar Tax Credit (ITC): 30% of total system cost reduces federal tax liability - on a $20,000 system, you recoup $6,000 at tax time",
      "Personal loan: no home equity required, unsecured, funded in 1-3 days, but rates are typically higher than solar-specific loans",
      "Solar-specific loans (Mosaic, Sunlight Financial): lower rates (5%-12%) but require the solar company to be a partner; you may be limited in installer choice",
      "PACE financing (Property Assessed Clean Energy): no FICO check, repaid via property tax bill, but adds a lien to your home and may complicate future sales",
      "After federal tax credit, typical payback period is 6-10 years - after which electricity is essentially free",
      "System increases home value: studies show homes with owned solar sell for 3%-4% more (Zillow research)",
    ],
    faqs: [
      { q: "Is a personal loan a good way to finance solar panels?", a: "It depends on your credit score and whether you qualify for better alternatives. At 720+ FICO: a dedicated solar loan (5%-9% APR) is likely cheaper than a personal loan (8%-13% APR) and worth the slightly more complex application process. At 660-719 FICO: personal loan and solar loan rates are often comparable; the personal loan's speed and simplicity become attractive. Below 620: personal loans may be the most accessible option if you do not have significant home equity, though rates will be higher. The 30% federal tax credit significantly reduces the amount you need to finance if you apply it against your loan in the first year." },
      { q: "What is the 30% solar tax credit and how does it interact with loan financing?", a: "The Investment Tax Credit (ITC) allows you to deduct 30% of your solar installation cost directly from your federal income tax liability. If you finance via a personal loan, you still receive the full 30% credit on the total system cost. The credit is not a refund - it reduces taxes owed. If your tax liability is less than the credit amount, you carry the remaining credit forward to future years. Many borrowers apply their tax refund to pay down the solar loan principal early, which reduces the effective interest cost substantially." },
      { q: "Should I use home equity or a personal loan for solar in 2026?", a: "Home equity (HELOC or home equity loan) typically offers lower rates (7%-10% APR vs. 10%-18% for personal loans at the same credit tier) and the interest may be tax-deductible if the loan is used for home improvement. The trade-offs: home equity requires 2-6 weeks to close, uses your home as collateral, and adds to mortgage debt. A personal loan closes in days, is unsecured, and is simpler. For solar systems, the improvement is permanent and adds value to the home, making home equity financing logical for homeowners with available equity. If speed is critical (seasonal incentives, installer scheduling) or equity is limited, a personal loan is a viable alternative." },
    ],
  },
  "garage-conversion": {
    slug: "garage-conversion",
    h1: "Personal Loan to Convert a Garage: ADU and Living Space Financing",
    title: "Garage Conversion Loan (2026): ADU Financing Costs and Options",
    description: "Converting a garage to living space (ADU, studio, office) costs $15,000-$75,000. Personal loans fund smaller conversions; HELOCs and ADU loans handle larger projects.",
    eyebrow: "Home conversion",
    intro: "Garage conversions range from a basic unfinished-to-finished space ($15,000-$25,000) to a full accessory dwelling unit (ADU) with kitchen and bath ($50,000-$100,000). The project scope, local permit requirements, and whether you need to add a bathroom and kitchen dramatically affect cost. Personal loans are practical for smaller conversions ($15,000-$40,000). Larger ADU projects often require home equity products (HELOC, cash-out refinance) or ADU-specific construction loans. Zoning approval and permits must be confirmed before any financing is arranged.",
    amountMin: 10000,
    amountMax: 50000,
    termMin: 24,
    termMax: 84,
    ...
    aprMax: 22,
    bullets: [
      "Garage conversions require permits in virtually all jurisdictions - confirm local zoning before starting any project",
      "ADUs (accessory dwelling units) are now legal in most California cities and many other states following zoning reform",
      "A permitted ADU adds measurable home value and may produce rental income to offset loan payments",
      "Personal loans: best for basic conversions ($15,000-$30,000) or when home equity is not available",
      "HELOC or cash-out refinance: typically better for larger ADU projects where lower rates matter more",
      "ADU-specific loan programs: some states (California, Oregon) offer dedicated ADU financing programs through housing agencies",
    ],
    faqs: [
      { q: "How much does a garage conversion cost in 2026?", a: "Cost ranges vary widely by project scope: Basic garage conversion (insulation, drywall, flooring, HVAC, electrical upgrade): $15,000-$30,000. Conversion with bathroom addition: $30,000-$55,000. Full ADU (kitchen, bath, full living space, separate entrance, permitted): $60,000-$120,000+ depending on region. Detached garage conversions are typically more expensive than attached garages due to utility connection requirements. California costs are typically 30%-50% higher than national averages due to permit fees and labor costs." },
      { q: "Does a garage conversion require permits?", a: "Yes, in virtually all jurisdictions. Converting garage space to habitable living area requires building permits (for structural, electrical, plumbing changes), zoning approval (confirming the conversion is allowed under local codes), and inspections at various stages. Unpermitted conversions cannot be legally rented, may create insurance complications, and must be disclosed in any home sale. Many buyers also insist unpermitted work be remediated before closing. Always permit the work before financing and starting construction." },
      { q: "Can a garage conversion pay for itself?", a: "In many markets, yes - particularly as an ADU rented as a long-term or short-term rental. Example: a $50,000 ADU conversion financed at 12% APR over 7 years costs $875/month in loan payments. If the ADU rents for $1,200-$1,800/month (a realistic range in many metros), the rental income exceeds the loan payment. After payoff, rental income is largely profit. Additionally, ADUs increase home resale value - in high-cost metros, an ADU addition can increase home value by $100,000-$200,000. The financial case is strongest in high-rent markets where the income potential justifies the construction cost." },
    ],
  },
  "flooring": {
    slug: "flooring",
    eyebrow: "Home improvement",
    h1: "Personal Loan for Flooring Installation",
    title: "Personal Loan for Flooring: Cost Estimates, APRs, and How to Finance New Floors in 2026",
    description: "Compare financing options for hardwood, luxury vinyl plank, tile, and carpet installation. Personal loan amounts of $3,000-$20,000 at 8%-25% APR for flooring projects.",
    intro: "Flooring installation is one of the most common home improvement projects. A personal loan of $3,000-$20,000 covers most full-home flooring replacements with no collateral required. The loan funds in 1-3 days, letting you hire contractors and purchase materials immediately.",
    amountMin: 3000,
    amountMax: 20000,
    termMin: 24,
    termMax: 84,
    ...
    aprMax: 25,
    bullets: [
      "Hardwood flooring: $6-$25 per square foot installed (material + labor). Average 1,500 sq ft home: $9,000-$37,500",
      "Luxury vinyl plank (LVP): $3-$10 per square foot installed. Most popular option for cost-to-durability ratio",
      "Tile: $7-$20 per square foot installed. Higher cost due to labor-intensive installation",
      "Carpet: $3-$8 per square foot installed. Lowest upfront cost but shortest lifespan",
      "Subfloor repair or leveling: $2-$10 per square foot, added to flooring cost if needed",
      "No collateral required for personal loans - home equity not at risk",
      "Fixed monthly payment over 2-7 years; most projects paid off in 3-5 years",
      "Flooring increases home value: hardwood adds $1-$5 per square foot in resale value in most markets",
    ],
    faqs: [
      { q: "How much does new flooring cost for an average house?", a: "For an average 1,500 square foot home replacing all flooring: Carpet throughout: $4,500-$12,000. Luxury vinyl plank (LVP) throughout: $4,500-$15,000. Hardwood throughout: $13,500-$37,500. Tile throughout (bathrooms + kitchen): $10,500-$30,000. Mixed (hardwood in main areas, tile in bathrooms, carpet in bedrooms): $8,000-$20,000 is a typical full-home replacement budget." },
      { q: "Is flooring a good investment in home value?", a: "Hardwood flooring consistently offers good ROI at resale - many real estate agents report it adds $1-$5 per square foot in resale value. Buyers actively seek hardwood in listing photos. LVP (luxury vinyl plank) is increasingly accepted by buyers and adds value in a more budget-friendly package. Carpet is the lowest-value option at resale; many buyers budget to replace carpet immediately after purchase. Tile is neutral to positive, especially in bathrooms and kitchens where it is expected." },
      { q: "Should I use a personal loan or home equity for flooring?", a: "Personal loan: faster (1-3 days), no collateral risk, fixed rate, good for amounts under $20,000 where the closing costs of a HELOC would be disproportionate. Home equity (HELOC): lower interest rate (typically 2%-5% below personal loan rates in 2026), better for larger projects ($20,000+), but requires equity, appraisal, and 2-4 week funding timeline. For a $10,000 flooring project, a personal loan is usually the right call. For a $40,000 full renovation that includes flooring, HELOC may be more cost-effective." },
    ],
  },
  "windows-doors": {
    slug: "windows-doors",
    eyebrow: "Home improvement",
    h1: "Personal Loan for Window and Door Replacement",
    title: "Personal Loan for Window Replacement: Cost, APR, and Financing Options in 2026",
    description: "Finance new windows and doors with a personal loan. Replacement window costs of $300-$800 per window; full-home replacement $5,000-$25,000. Compare APRs and loan terms.",
    intro: "Replacing windows and exterior doors is a major home improvement that improves energy efficiency, comfort, and curb appeal. A personal loan of $5,000-$25,000 covers most full-home window replacements without requiring home equity or a secured loan.",
    amountMin: 5000,
    amountMax: 25000,
    termMin: 24,
    termMax: 84,
